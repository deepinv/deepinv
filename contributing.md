...
instance, the case for [`PET physics`](https://deepinv.org/api/stubs/deepinv.physics.PET.md#deepinv.physics.PET).
...
> When ground truth $x$ is available, we can simply maximize the PSNR: see [Calibrating physics operators](https://deepinv.org/auto_examples/blind-inverse-problems/demo_optimizing_physics_parameter.md#sphx-glr-auto-examples-blind-inverse-problems-demo-optimizing-physics-parameter-py) for an example.
...
- Registering the physics in the appropriate test suite and verifying that the tests pass – when inheriting from [`deepinv.physics.LinearPhysics`](https://deepinv.org/api/stubs/deepinv.physics.LinearPhysics.md#deepinv.physics.LinearPhysics), it involves the following modifications to `deepinv/tests/test_physics.py`:
...
- [`deepinv.physics.Scattering`](https://deepinv.org/api/stubs/deepinv.physics.Scattering.md#deepinv.physics.Scattering) in [#1020](https://github.com/deepinv/deepinv/pull/1020)
- [`deepinv.physics.SpatialUnwrapping`](https://deepinv.org/api/stubs/deepinv.physics.SpatialUnwrapping.md#deepinv.physics.SpatialUnwrapping) in [#723](https://github.com/deepinv/deepinv/pull/723)
- [`deepinv.physics.TomographyWithAstra`](https://deepinv.org/api/stubs/deepinv.physics.TomographyWithAstra.md#deepinv.physics.TomographyWithAstra) in [#474](https://github.com/deepinv/deepinv/pull/474)
