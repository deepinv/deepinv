...
| Magnetic Resonance Imaging (MRI) | Single and multi-Coil MRI, Dynamic MRI, Sequential MRI (All support 3D MRI) | Gaussian, random and equispaced masks |
| Tomography                     | Parallel beam                                                                   |                                                                                |
