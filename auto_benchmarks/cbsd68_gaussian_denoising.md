...
- *Dataset*: [`CBSD68`](https://deepinv.org/api/stubs/deepinv.datasets.CBSD68.md#deepinv.datasets.CBSD68)
- *Physics*: [`Denoising`](https://deepinv.org/api/stubs/deepinv.physics.Denoising.md#deepinv.physics.Denoising)
- *Noise model*: [`GaussianNoise`](https://deepinv.org/api/stubs/deepinv.physics.GaussianNoise.md#deepinv.physics.GaussianNoise)
- *sigma*: 0.1
- *img_size*: 256
