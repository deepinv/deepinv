...
The API is the same as for [distributed reconstruction](https://deepinv.org/user_guide/distributed/reconstruction.md#distributed-reconstruction):

1. [`deepinv.distributed.DistributedContext`](https://deepinv.org/api/stubs/deepinv.distributed.DistributedContext.md#deepinv.distributed.DistributedContext) manages the processes and devices
2. [`deepinv.distributed.distribute()`](https://deepinv.org/api/stubs/deepinv.distributed.distribute.md#deepinv.distributed.distribute) converts deepinv objects to distributed versions
...
[`deepinv.Trainer`](https://deepinv.org/api/stubs/deepinv.Trainer.md#deepinv.Trainer) workflow. The distributed objects handle the
communication needed by the forward pass and by backpropagation.

#### NOTE
See [Distributed Training of Unfolded Networks](https://deepinv.org/auto_examples/distributed/demo_unrolled_distributed.md#sphx-glr-auto-examples-distributed-demo-unrolled-distributed-py)
...
**Unfolded algorithms**: unfolded models such as [`deepinv.optim.DRS`](https://deepinv.org/api/stubs/deepinv.optim.DRS.md#deepinv.optim.DRS) can
...
For a [`stacked physics`](https://deepinv.org/api/stubs/deepinv.physics.StackedPhysics.md#deepinv.physics.StackedPhysics) $A = [A_1, \ldots, A_N]$, each rank owns a subset of
...
For unfolded models, [`deepinv.distributed.distribute()`](https://deepinv.org/api/stubs/deepinv.distributed.distribute.md#deepinv.distributed.distribute) replaces the
...
- If measurements are stored as a list or [`deepinv.utils.TensorList`](https://deepinv.org/api/stubs/deepinv.utils.TensorList.md#deepinv.utils.TensorList), move each tensor to the device.
...
**Through data fidelity terms**: losses such as [`deepinv.optim.data_fidelity.L2`](https://deepinv.org/api/stubs/deepinv.optim.L2.md#deepinv.optim.L2)
...
[`deepinv.distributed.DistributedContext`](https://deepinv.org/api/stubs/deepinv.distributed.DistributedContext.md#deepinv.distributed.DistributedContext) detects whether distributed
...
- **Complete example**: [Distributed Training of Unfolded Networks](https://deepinv.org/auto_examples/distributed/demo_unrolled_distributed.md#sphx-glr-auto-examples-distributed-demo-unrolled-distributed-py)
- **Distributed reconstruction guide**: [Distributed Reconstruction](https://deepinv.org/user_guide/distributed/reconstruction.md#distributed-reconstruction)
- **Trainer guide**: [Trainer](https://deepinv.org/user_guide/training/trainer.md#trainer)
- **Multi-GPU training guide**: [Using Multiple GPUs](https://deepinv.org/user_guide/training/multigpu.md#multigpu)
