...
1. [`deepinv.distributed.DistributedContext`](https://deepinv.org/api/stubs/deepinv.distributed.DistributedContext.md#deepinv.distributed.DistributedContext) - manages distributed execution
2. [`deepinv.distributed.distribute()`](https://deepinv.org/api/stubs/deepinv.distributed.distribute.md#deepinv.distributed.distribute) - converts regular objects to distributed versions
...
**That’s the entire API!** The [`deepinv.distributed.distribute()`](https://deepinv.org/api/stubs/deepinv.distributed.distribute.md#deepinv.distributed.distribute) function handles all the complexity of distributed computing.
...
The [`deepinv.distributed.distribute()`](https://deepinv.org/api/stubs/deepinv.distributed.distribute.md#deepinv.distributed.distribute) function:
...
#### NOTE
Check out the [distributed physics example](https://deepinv.org/auto_examples/distributed/demo_physics_distributed.md#sphx-glr-auto-examples-distributed-demo-physics-distributed-py) for a complete demo.
...
#### NOTE
Check out the [distributed denoiser example](https://deepinv.org/auto_examples/distributed/demo_denoiser_distributed.md#sphx-glr-auto-examples-distributed-demo-denoiser-distributed-py) for a complete demo.
...
[`deepinv.distributed.strategies.DistributedSignalStrategy`](https://deepinv.org/api/stubs/deepinv.distributed.strategies.DistributedSignalStrategy.md#deepinv.distributed.strategies.DistributedSignalStrategy):
...
| Class                                                                                                                                                                        | Description                                                                            |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|
| [`deepinv.distributed.DistributedContext`](https://deepinv.org/api/stubs/deepinv.distributed.DistributedContext.md#deepinv.distributed.DistributedContext)                                               | Manages distributed execution, process groups, and devices                             |
| [`deepinv.distributed.framework.DistributedStackedPhysics`](https://deepinv.org/api/stubs/deepinv.distributed.framework.DistributedStackedPhysics.md#deepinv.distributed.framework.DistributedStackedPhysics)             | Distributes physics operators across processes (auto-created by `distribute()`)        |
| [`deepinv.distributed.framework.DistributedStackedLinearPhysics`](https://deepinv.org/api/stubs/deepinv.distributed.framework.DistributedStackedLinearPhysics.md#deepinv.distributed.framework.DistributedStackedLinearPhysics) | Extends DistributedStackedPhysics for linear operators with adjoint operations         |
| [`deepinv.distributed.framework.DistributedProcessing`](https://deepinv.org/api/stubs/deepinv.distributed.framework.DistributedProcessing.md#deepinv.distributed.framework.DistributedProcessing)                     | Distributes denoisers/priors using spatial tiling (auto-created by `distribute()`)     |
| [`deepinv.distributed.framework.DistributedDataFidelity`](https://deepinv.org/api/stubs/deepinv.distributed.framework.DistributedDataFidelity.md#deepinv.distributed.framework.DistributedDataFidelity)                 | Distributes data fidelity `fn` and `grad`` (if needed, auto-created by `distribute()`) |

**You typically won’t need to instantiate these classes directly.** Use the [`deepinv.distributed.distribute()`](https://deepinv.org/api/stubs/deepinv.distributed.distribute.md#deepinv.distributed.distribute) function instead.
...
- **API Reference**: [deepinv.distributed](https://deepinv.org/api/deepinv.distributed.md)
- **Examples**:
  - [Distributed Physics Operators](https://deepinv.org/auto_examples/distributed/demo_physics_distributed.md#sphx-glr-auto-examples-distributed-demo-physics-distributed-py)
  - [Distributed Denoiser with Image Tiling](https://deepinv.org/auto_examples/distributed/demo_denoiser_distributed.md#sphx-glr-auto-examples-distributed-demo-denoiser-distributed-py)
  - [Distributed Plug-and-Play (PnP) Reconstruction](https://deepinv.org/auto_examples/distributed/demo_pnp_distributed.md#sphx-glr-auto-examples-distributed-demo-pnp-distributed-py)
- **Related**:
  - [`deepinv.physics.StackedPhysics`](https://deepinv.org/api/stubs/deepinv.physics.StackedPhysics.md#deepinv.physics.StackedPhysics) for multi-operator physics
  - [Optimization algorithms](https://deepinv.org/user_guide/reconstruction/optimization.md#optim) for reconstruction methods
