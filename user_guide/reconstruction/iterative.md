...
See the [available data fidelity terms](https://deepinv.org/user_guide/reconstruction/optimization.md#data-fidelity).

The prior term $g_{\sigma}$ can be chosen as (See [available options](https://deepinv.org/user_guide/reconstruction/optimization.md#priors)):
...
Iterative algorithms can be easily implemented using the [optim module](https://deepinv.org/user_guide/reconstruction/optimization.md#optim), which provides many
pre-implemented [data-fidelity](https://deepinv.org/user_guide/reconstruction/optimization.md#data-fidelity) and [prior terms](https://deepinv.org/user_guide/reconstruction/optimization.md#priors) (including PnP and RED),
...
[PnP with custom optimization algorithm (Primal-Dual Condat-Vu)](https://deepinv.org/auto_examples/plug-and-play/demo_PnP_custom_optim.md#sphx-glr-auto-examples-plug-and-play-demo-pnp-custom-optim-py) for more details.
...
| **Method**                                                                             | **Description**                           |
|----------------------------------------------------------------------------------------|-------------------------------------------|
| [`deepinv.optim.DPIR`](https://deepinv.org/api/stubs/deepinv.optim.DPIR.md#deepinv.optim.DPIR) | Custom PnP algorithm with early stopping. |
| [`deepinv.optim.EPLL`](https://deepinv.org/api/stubs/deepinv.optim.EPLL.md#deepinv.optim.EPLL) | Patch-based reconstruction algorithm      |
