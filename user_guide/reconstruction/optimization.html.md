...
| [`deepinv.optim.SmoothedTVPrior`](https://deepinv.org/api/stubs/deepinv.optim.SmoothedTVPrior.html.md#deepinv.optim.SmoothedTVPrior) | $\reg{x}=\sum_i\sqrt{\|(Dx)_i\|_2^2 + \varepsilon^2}$ where $D$ is a finite difference operator | Yes                   |
