...
def get_drunet_dataset(train_patch_size, device='cpu', train=True, train_pth='/pth/to/train', val_pth='/pth/to/val',
    ...
    if train:
        dataset = torchvision.datasets.ImageFolder(root=train_pth,
                                                   transform=transform)
    else:
        dataset = torchvision.datasets.ImageFolder(root=val_pth,
                                                   transform=transform)
