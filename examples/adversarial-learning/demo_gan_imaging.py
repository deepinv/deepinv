...
# discriminator from PatchGAN :cite:`isola2017image`, but
...
# ~~~~~~~~~~~~~
#
# Unsupervised Adversarial Image Reconstruction (UAIR) :cite:`pajot2019unsupervised`
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~
#
# Compressed Sensing using Generative Models (CSGM) :cite:`bora2017compressed` and AmbientGAN :cite:`bora2018ambientgan` are two methods for solving inverse problems
