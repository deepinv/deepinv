...
This example shows how to use Total-Variation regularization to solve a low-dose computed tomography problem. We use the ``TomographyWithAstra`` operator which wraps the [astra-toolbox](https://astra-toolbox.com/) backend in a custom ``LinearPhysics`` operator.
