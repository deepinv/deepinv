...
See :footcite:ps:`hurault2023convergent` for more details.
...
In this example, we use the DnCNN denoiser :footcite:ps:`zhang2017beyond`. As the observation has been corrupted with Poisson noise, we use the :class:`deepinv.optim.PoissonLikelihood` data-fidelity term.
In :footcite:ps:`Bolte2016descent`, it is shown that, with this data-fidelity term, the right Bregman potential to use is Burg's entropy :class:`deepinv.optim.bregman.BurgEntropy`.
"""
