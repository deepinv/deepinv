...
In this tutorial, we revisit the implementation of the DiffPIR diffusion algorithm for image reconstruction from :cite:`zhu2023denoising`.
...
# of DiffPIR use a U-Net architecture from :cite:`ho2020denoising`,
