...
sample_seed_111 = sde.sample((1, 3, 64, 64), seed=111, get_trajectory=False)
...
sample, trajectory = sde.sample((1, 3, 64, 64), seed=101, get_trajectory=True)
...
# We then can generate an image by solving the reverse-time SDE
sample, trajectory = sde.sample((1, 3, 64, 64), seed=111, get_trajectory=True)
...
# We then can generate an image by solving the reverse-time SDE
sample, trajectory = sde.sample((1, 3, 64, 64), seed=10, get_trajectory=True)
