...
This code shows you how to use the :class:`deepinv.sampling.DiffusionSDE` to generate from a pre-trained denoiser
and :class:`deepinv.sampling.PosteriorDiffusion` to perform posterior sampling.
...
* A well-trained denoiser with varying noise levels (ideally with large noise levels) (e.g., :class:`deepinv.model.NCSNpp`).
