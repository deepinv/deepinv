...
from deepinv.sampling.noisy_datafidelity import DPSDataFidelity, ILVR
...
x_true = load_image("../../datasets/set3c/0/butterfly.png", img_size=256).to(device)
x = x_true.clone()
...
weight = 0.3  # guidance strength
dps_fidelity = DPSDataFidelity(denoiser=denoiser, weight=weight)
# dps_fidelity = ILRV(denoiser=denoiser, weight=weight)
