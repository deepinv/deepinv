r"""
Comparing diffusion sampling algorithms
========================================

This demo compares different flow-based sampling algorithms for posterior sampling.
In particular, it shows how to use the different Flow Matching and Diffusion models of the library.
