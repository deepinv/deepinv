...
inverse_singulars = (
    1.0 / physics.mask
)  # Sigma_dagger == pseudo inverse see eq (37) of DDNM paper
...
case = (
    sigma < at.sqrt() * sigma_noise * inverse_singulars
)  # see svd_operators.py Lambda from DDNM code l. 377 + eq (64) of paper
Lambda_t[case] = (
    physics.mask[case]
    * sigma.item()
    * (1 - eta**2) ** 0.5
    / at.sqrt().item()
    / sigma_noise
)  # see svd_operators.py Lambda from DDNM code l. 378 + eq (64) of paper
