...
The PnP-ULA method is described in the paper :cite:`laumont2022bayesian`.
"""
...
# which makes sure that the denoiser is firmly non-expansive (see :cite:`terris2020building`), and helps to
