...
y = y.unsqueeze(0).unsqueeze(0)  # add batch and channel dimensions (B, C, N_proj, H', W')
...
psf_meta = dicom.get_psfmeta_from_scanner_params(collimator_name, energy_kev, intrinsic_resolution=intrinsic_resolution)
psf_transform = SPECTPSFTransform(psf_meta)

physics = Emission_Tomography(object_meta, proj_meta, att_transform, psf_transform, noise_model=dinv.physics.PoissonNoise())
