...
* The expected patch log-likelihood (EPLL) prior was proposed in :footcite:t:`zoran2011learning`.
...
* The patch normalizing flow regularizer (PatchNR) was proposed in :footcite:t:`altekruger2023patchnr`.
