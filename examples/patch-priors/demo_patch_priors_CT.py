...
* The expected patch log-likelihood (EPLL) prior was proposed in :footcite:ps:`zoran2011learning`.
...
* The patch normalizing flow regularizer (PatchNR) was proposed in :footcite:ps:`altekruger2023patchnr`.
