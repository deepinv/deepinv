...
* The expected patch log-likelihood (EPLL) prior was proposed in :cite:`zoran2011learning`.
...
* The patch normalizing flow regularizer (PatchNR) was proposed in :cite:`altekruger2023patchnr`.
