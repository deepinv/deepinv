...
The following example and data are taken from :cite:`aghabiglou2024r2d2`.
...
# Groundtruth image
# ----------------------------------------------------------------------------------------
# The following data is our groundtruth with the settings of Experiment II in :cite:`aghabiglou2024r2d2`.
...
# Please check :cite:`terris2023image` and :cite:`aghabiglou2024r2d2``
