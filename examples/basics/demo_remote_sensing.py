...
We provide a convenient satellite image dataset for pan-sharpening :class:`deepinv.datasets.NBUDataset` provided in the paper :cite:`meng2020large`.
...
# For example, we use here the PanNet :cite:`yang2017pannet` model.
#
...
# pan-sharpening in :cite:`wang2024perspective`.
#
