...
This example shows how to implement the LISTA algorithm :footcite:ps:`gregor2010learning`,
...
# ------------------------------------------------------------------------
# In this example, following the original LISTA algorithm :footcite:ps:`gregor2010learning`
