...
from deepinv.models.denoiser import ProxDenoiser, REDDenoiser
...
model = Optim(algo_name = 'PGD', grad_g=grad_g, g_first = True, data_fidelity=data_fidelity, lamb=lamb, device=dinv.device,
