...
computed tomography, as is the case in Noise2Inverse :cite:`hendriksen2020noise2inverse`. Note this example
can also be easily applied to undersampled multicoil MRI as is the case
in SSDU :cite:`yaman2020self`.
...
#    ``eval_split_input`` (as is the case in SSDU :cite:`yaman2020self`).
...
# SSDU :cite:`yaman2020self`). This generally is
