...
prior = {'g': [CustomPrior()]}
F_fn = lambda x,cur_params,y,physics : params_algo['lamb']*data_fidelity.f(physics.A(x), y) + prior['g'][0](x,cur_params['g_param'])
F_fn = None
model = Optim(algo_name = 'PGD', prior=prior, g_first = False, data_fidelity=data_fidelity,
             ...
             thres_conv=thres_conv, backtracking=False, F_fn=F_fn, return_dual=False, verbose=True, return_metrics = plot_metrics,
