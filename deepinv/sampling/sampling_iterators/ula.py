...
class ULAIterator(SamplingIterator):
    ...
    def forward(self, x, y, physics, cur_data_fidelity, cur_prior, cur_params, *args, **kwargs):
...
class SKRockIterator(SamplingIterator):
    ...
    def forward(self, x, y, physics, cur_data_fidelity, cur_prior, cur_params, *args, **kwargs):
        ...
        posterior = lambda u: -cur_data_fidelity.grad(u, y, physics) + alpha * (-cur_prior.grad(u, sigma))
