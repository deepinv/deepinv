...
class Bregman(Potential):
    ...
    def __init__(self, phi: Callable[[Tensor], Tensor] = None):
        super().__init__(fn=phi)

    def div(self, x: Tensor, y: Tensor, *args, **kwargs) -> Tensor:
        r"""
    ...
    def MD_step(
        self, x: Tensor, grad: Tensor, *args, gamma: float = 1.0, **kwargs
    ) -> Tensor:
        r"""
...
class BregmanL2(Bregman):
    ...
    def conjugate(self, x: Tensor) -> Tensor:
        r"""
    ...
    def grad_conj(self, x: Tensor, *args, **kwargs) -> Tensor:
        r"""
