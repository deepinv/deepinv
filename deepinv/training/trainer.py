...
class Trainer:
    ...
    or :meth:`deepinv.Trainer.get_samples_offline` methods, e.g. to change the physics parameters on-the-fly with parameters
    from your dataset (useful for MRI where each mask has its own, different, mask):
