...
class SureGaussianLoss(Loss):
    ...
    using the Monte Carlo approximation in :footcite:ps:`luisier2007new`.
    ...
    .. note::
        ...
        If the noise level is unknown, the loss can be adapted to the UNSURE loss introduced in :footcite:ps:`tachella2024unsure`,
    ...
    :param bool unsure: If ``True``, the loss is adapted to the UNSURE loss introduced in :footcite:ps:`tachella2024unsure`
...
class SurePoissonLoss(Loss):
    ...
    See :footcite:ps:`le2014unbiased` for details.
...
class SurePGLoss(Loss):
    ...
    .. note::
        ...
        If the noise levels are unknown, the loss can be adapted to the UNSURE loss introduced in :footcite:ps:`tachella2024unsure`,
