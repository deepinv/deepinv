...
class SureGaussianLoss(Loss):
    ...
    .. note::
        ...
        If the noise level is unknown, the loss can be adapted to the UNSURE loss introduced in :footcite:t:`tachella2024unsure`,
    ...
    :param bool unsure: If ``True``, the loss is adapted to the UNSURE loss introduced in :footcite:t:`tachella2024unsure`
...
class SurePGLoss(Loss):
    ...
    .. note::
        ...
        If the noise levels are unknown, the loss can be adapted to the UNSURE loss introduced in :footcite:t:`tachella2024unsure`,
