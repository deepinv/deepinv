...
def cumpute_patch_info(image_size: Tuple[int], patch_size: Tuple[int], overlap: Tuple[int]):
    r"""
    ...
    :returns: (Dictionary) a dictionary containing all information about the patches
    """
    stride = add_tuple(patch_size, overlap, -1)
    num_patches = (image_size[0] // stride[0],
                   image_size[1] // stride[1])
