...
class Scattering(Physics):
    ...
    class SolverConfig:
        ...
        :param str solver: Linear solver to use (`'lsqr'`, `'lsmr'`, `'BiCGStab'`, `'minres'` or `'CG'`). By default, `'lsqr'`.
...
class BornOperator(LinearPhysics):
    ...
    def A_dagger(
        ...
        **kwargs,
        ...
        :param str solver: Solver to use (`'lsqr'`, `'lsmr'`, `'BiCGStab'`, `'minres'` or `'CG'`), see :func:`deepinv.optim.linear.least_squares`.
