...
def apply_homography(
    ...
    **kwargs,
    ...
    Following :cite:`wang2024perspective`, we assume principal point in centre, initial focal length 100, initial skew of 0, initial square pixels.
...
class Homography(Transform):
    ...
    retrieved, see :cite:`wang2024perspective`.
...
class PanTiltRotate(Homography):
    ...
    or "pan+tilt+rotate" subgroup from :cite:`wang2024perspective`.
