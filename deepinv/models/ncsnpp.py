...
class NCSNpp(Denoiser):
    ...
    def __init__(
        ...
        channel_mult: list = None,  # Per-resolution multipliers for the number of channels.
        ...
        attn_resolutions: list = None,  # List of resolutions with self-attention.
        ...
        resample_filter: list = None,  # Resampling filter: [1,1] for DDPM++, [1,3,3,1] for NCSN++.
