...
class SwinIR(Denoiser):
    ...
    The Swin Image Restoration (SwinIR) denoising network was introduced in :cite:`liang2021swinir`. This code is adapted from the official implementation by the
    authors.
