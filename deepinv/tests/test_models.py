...
def test_dip(imsize, device):
    ...
    f = dinv.models.DeepImagePrior(generator=dinv.models.ConvDecoder(imsize, layers=3, channels=channels).to(device),
                                   input_size=(channels, imsize[1], imsize[2]), iterations=30)
