...
def unfolded_builder(iteration, params_algo={"lambda": 1.0, "stepsize": 1.0}, data_fidelity=L2(), prior=None, F_fn=None, g_first=False, **kwargs):
    r"""
    ...
    return BaseUnfold(iterator, has_cost=iterator.has_cost, prior=prior, params_algo=params_algo, **kwargs)
