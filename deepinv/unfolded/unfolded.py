...
class Unfolded_ADMM(BaseUnfold):
    def __init__(self, g_first=False, F_fn=None, **kwargs):
        super(Unfolded_ADMM, self).__init__(
            ADMMIteration(g_first=g_first, F_fn=F_fn), **kwargs
        )


class Unfolded_DRS(BaseUnfold):
    def __init__(self, g_first=False, F_fn=None, **kwargs):
        super(Unfolded_DRS, self).__init__(
            DRSIteration(g_first=g_first, F_fn=F_fn), **kwargs
        )


class Unfolded_GradientDescent(BaseUnfold):
    def __init__(self, F_fn=None, **kwargs):
        super(Unfolded_GradientDescent, self).__init__(GDIteration(F_fn=F_fn), **kwargs)


class Unfolded_HQS(BaseUnfold):
    def __init__(self, g_first=False, F_fn=None, **kwargs):
        super(Unfolded_HQS, self).__init__(
            HQSIteration(g_first=g_first, F_fn=F_fn), **kwargs
        )


class Unfolded_ProximalGradientDescent(BaseUnfold):
    def __init__(self, g_first=False, F_fn=None, **kwargs):
        super(Unfolded_ProximalGradientDescent, self).__init__(
            PGDIteration(g_first=g_first, F_fn=F_fn), **kwargs
        )


class Unfolded_FISTA(BaseUnfold):
    def __init__(self, g_first=False, F_fn=None, **kwargs):
...
class Unfolded_PrimalDualCP(BaseUnfold):
    def __init__(self, g_first=False, F_fn=None, **kwargs):
        super(Unfolded_PrimalDualCP, self).__init__(
