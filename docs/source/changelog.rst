...
- New ``vmin`` and ``vmax`` arguments in :func:`deepinv.utils.plot` and :func:`deepinv.utils.plotting.preprocess_img` to set custom clipping bounds when using ``rescale_mode='clip'`` (:gh:`967` by `Thibaut Modrzyk`_)
