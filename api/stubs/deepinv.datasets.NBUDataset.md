...
outputting a [`deepinv.utils.TensorList`](https://deepinv.org/api/stubs/deepinv.utils.TensorList.md#deepinv.utils.TensorList) of `(MS, PAN)` where `PAN` are 1024x1024 panchromatic images.
...
See [Remote sensing with satellite images](https://deepinv.org/auto_examples/physics/demo_remote_sensing.md#sphx-glr-auto-examples-physics-demo-remote-sensing-py) for example using
