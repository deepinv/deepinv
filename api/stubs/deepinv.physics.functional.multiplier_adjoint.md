...
The adjoint of this operation is [`deepinv.physics.functional.multiplier()`](https://deepinv.org/api/stubs/deepinv.physics.functional.multiplier.md#deepinv.physics.functional.multiplier)
