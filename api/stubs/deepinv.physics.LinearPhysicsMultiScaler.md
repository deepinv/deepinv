...
Bases: [`PhysicsMultiScaler`](https://deepinv.org/api/stubs/deepinv.physics.PhysicsMultiScaler.md#deepinv.physics.PhysicsMultiScaler), [`LinearPhysics`](https://deepinv.org/api/stubs/deepinv.physics.LinearPhysics.md#deepinv.physics.LinearPhysics)

Multi-scale wrapper for linear physics operators.

See [`PhysicsMultiScaler`](https://deepinv.org/api/stubs/deepinv.physics.PhysicsMultiScaler.md#deepinv.physics.PhysicsMultiScaler) for details.
...
* **Examples:**
  ...
  ```
* **Parameters:**
  * **physics** ([*deepinv.physics.Physics*](https://deepinv.org/api/stubs/deepinv.physics.Physics.md#deepinv.physics.Physics)) – base physics operator.
