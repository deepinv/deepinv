...
Bases: [`Homography`](https://deepinv.org/api/stubs/deepinv.transform.Homography.md#deepinv.transform.Homography)
...
uniform scale. These transformations are parametrized using geometric parameters in the pinhole camera model. See [`deepinv.transform.Homography`](https://deepinv.org/api/stubs/deepinv.transform.Homography.md#deepinv.transform.Homography) for more details.
