...
Amplitude loss as the data fidelity term for [`deepinv.physics.PhaseRetrieval()`](https://deepinv.org/api/stubs/deepinv.physics.PhaseRetrieval.md#deepinv.physics.PhaseRetrieval) reconstrunction.
