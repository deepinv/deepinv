...
The FISTA iterations are defined in the iterator class [`deepinv.optim.optim_iterators.FISTAIteration`](https://deepinv.org/api/stubs/deepinv.optim.optim_iterators.FISTAIteration.md#deepinv.optim.optim_iterators.FISTAIteration).
