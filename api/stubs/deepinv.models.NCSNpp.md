...
See the [diffusion SDE implementations](https://deepinv.org/user_guide/reconstruction/sampling.md#diffusion) for more details on the VP-SDE and VE-SDE from Song *et al.*<sup>[1](#footcite-song2020score)</sup>.
