...
Corresponds to [`deepinv.physics.LogPoissonNoise`](https://deepinv.org/api/stubs/deepinv.physics.LogPoissonNoise.md#deepinv.physics.LogPoissonNoise) with the same arguments $N_0$ and $\mu$.
