...
Identical to [`deepinv.sampling.BaseSDE.sample()`](https://deepinv.org/api/stubs/deepinv.sampling.BaseSDE.html.md#deepinv.sampling.BaseSDE.sample), except that under
`minus_one_one` the sample, given in $[-1, 1]$ is mapped back to $[0, 1]$.

See [`deepinv.sampling.BaseSDE.sample()`](https://deepinv.org/api/stubs/deepinv.sampling.BaseSDE.html.md#deepinv.sampling.BaseSDE.sample) for the parameters.
