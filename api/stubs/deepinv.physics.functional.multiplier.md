...
The adjoint of this operation is [`deepinv.physics.functional.multiplier_adjoint()`](https://deepinv.org/api/stubs/deepinv.physics.functional.multiplier_adjoint.md#deepinv.physics.functional.multiplier_adjoint)
