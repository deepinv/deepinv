...
#### WARNING
This a legacy class provided for convenience. See the example in [Markov Chain Monte Carlo](https://deepinv.org/user_guide/reconstruction/sampling.md#mcmc) for details on how to build a SKRock sampler.
