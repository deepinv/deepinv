...
The Primal Dual CP iterations are defined in the iterator class [`deepinv.optim.optim_iterators.CPIteration`](https://deepinv.org/api/stubs/deepinv.optim.optim_iterators.CPIteration.md#deepinv.optim.optim_iterators.CPIteration).
