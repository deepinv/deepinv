...
The algorithm, introduced by Laumont *et al.* [[84](https://deepinv.org/user_guide/other/biblio.md#id63)] runs the following markov chain iteration
(Algorithm 2 from [[84](https://deepinv.org/user_guide/other/biblio.md#id63)]):
...
* **Parameters:**
  ...
  * **physics** ([*Physics*](https://deepinv.org/api/stubs/deepinv.physics.Physics.md#deepinv.physics.Physics)) – Forward operator $A$ that models the measurement process
  * **cur_data_fidelity** ([*DataFidelity*](https://deepinv.org/api/stubs/deepinv.optim.DataFidelity.md#deepinv.optim.DataFidelity)) – Negative log-likelihood function
  * **cur_prior** ([*ScorePrior*](https://deepinv.org/api/stubs/deepinv.optim.ScorePrior.md#deepinv.optim.ScorePrior)) – Score-based prior model for $\nabla \log p(x)$
