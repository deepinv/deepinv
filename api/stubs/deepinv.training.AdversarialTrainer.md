...
Bases: [`Trainer`](https://deepinv.org/api/stubs/deepinv.Trainer.md#deepinv.Trainer)

Trainer class for training a reconstruction network using adversarial learning.

It overrides the [`deepinv.Trainer`](https://deepinv.org/api/stubs/deepinv.Trainer.md#deepinv.Trainer) class to provide the same functionality,
...
The adversarial losses themselves are defined in the [Adversarial Learning](https://deepinv.org/user_guide/training/loss.md#adversarial-losses) module.
Examples of discriminators are in [Adversarial Networks](https://deepinv.org/user_guide/reconstruction/adversarial.md#adversarial).

See [Imaging inverse problems with adversarial networks](https://deepinv.org/auto_examples/adversarial-learning/demo_gan_imaging.md#sphx-glr-auto-examples-adversarial-learning-demo-gan-imaging-py) for usage.
...
See [`deepinv.Trainer`](https://deepinv.org/api/stubs/deepinv.Trainer.md#deepinv.Trainer) for additional parameters.
...
* **Parameters:**
  * **optimizer** ([*deepinv.training.AdversarialOptimizer*](https://deepinv.org/api/stubs/deepinv.training.AdversarialOptimizer.md#deepinv.training.AdversarialOptimizer)) – optimizer encapsulating both generator and discriminator optimizers
  * **losses_d** ([*Loss*](https://deepinv.org/api/stubs/deepinv.loss.Loss.md#deepinv.loss.Loss) *,* [*list*](https://docs.python.org/3.9/library/stdtypes.html#list)) – losses to train the discriminator, e.g. adversarial losses
