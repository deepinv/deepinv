...
Base class for solving Stochastic Differential Equations (SDEs) from [`deepinv.sampling.BaseSDE`](https://deepinv.org/api/stubs/deepinv.sampling.BaseSDE.md#deepinv.sampling.BaseSDE) of the form:
...
* **Returns:**
  SDEOutput
* **Return type:**
  [SDEOutput](https://deepinv.org/api/stubs/deepinv.sampling.SDEOutput.md#deepinv.sampling.SDEOutput)
