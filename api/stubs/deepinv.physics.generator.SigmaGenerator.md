...
Generator for the noise level $\sigma$ in the [`Gaussian noise model`](https://deepinv.org/api/stubs/deepinv.physics.GaussianNoise.md#deepinv.physics.GaussianNoise).
