...
Bases: [`BaseUnfold`](https://deepinv.org/api/stubs/deepinv.unfolded.BaseUnfold.md#deepinv.unfolded.BaseUnfold)

Base class for deep equilibrium (DEQ) algorithms. Child of [`deepinv.unfolded.BaseUnfold`](https://deepinv.org/api/stubs/deepinv.unfolded.BaseUnfold.md#deepinv.unfolded.BaseUnfold).
...
The forward pass of the DEQ algorithm. Compared to [`deepinv.unfolded.BaseUnfold`](https://deepinv.org/api/stubs/deepinv.unfolded.BaseUnfold.md#deepinv.unfolded.BaseUnfold), the backward algorithm is performed using fixed point iterations.

* **Parameters:**
  * **y** ([*torch.Tensor*](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor)) – Input tensor.
  * **physics** ([*deepinv.physics.Physics*](https://deepinv.org/api/stubs/deepinv.physics.Physics.md#deepinv.physics.Physics)) – Physics object.
