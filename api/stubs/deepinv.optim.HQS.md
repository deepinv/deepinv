...
The HQS iterations are defined in the iterator class [`deepinv.optim.optim_iterators.HQSIteration`](https://deepinv.org/api/stubs/deepinv.optim.optim_iterators.HQSIteration.md#deepinv.optim.optim_iterators.HQSIteration).
