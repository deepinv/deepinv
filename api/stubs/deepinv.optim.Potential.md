...
* **Parameters:**
  ...
  * **bregman_potential** ([*deepinv.optim.bregman.Bregman*](https://deepinv.org/api/stubs/deepinv.optim.Bregman.md#deepinv.optim.Bregman)) – Bregman potential to be used in the Bregman proximity operator.
