...
as emission / attenuation maps and hot lesions, see [`deepinv.datasets.BrainWebPET`](https://deepinv.org/api/stubs/deepinv.datasets.BrainWebPET.md#deepinv.datasets.BrainWebPET).
