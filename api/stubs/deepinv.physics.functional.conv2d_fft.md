...
The adjoint of this operation is [`deepinv.physics.functional.conv_transpose2d_fft()`](https://deepinv.org/api/stubs/deepinv.physics.functional.conv_transpose2d_fft.md#deepinv.physics.functional.conv_transpose2d_fft)
...
This function gives the same result as [`deepinv.physics.functional.conv2d()`](https://deepinv.org/api/stubs/deepinv.physics.functional.conv2d.md#deepinv.physics.functional.conv2d) and is faster for large kernels.
