...
Bases: [`Distance`](https://deepinv.org/api/stubs/deepinv.optim.Distance.md#deepinv.optim.Distance)
...
* **Parameters:**
  ...
  * **denormalize** ([*bool*](https://docs.python.org/3.9/library/functions.html#bool)) – if True, the measurement is divided by the gain. By default, in the
    [`deepinv.physics.PoissonNoise`](https://deepinv.org/api/stubs/deepinv.physics.PoissonNoise.md#deepinv.physics.PoissonNoise), the measurements are multiplied by the gain after being sampled by
