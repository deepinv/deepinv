...
Bases: [`Bregman`](https://deepinv.org/api/stubs/deepinv.optim.Bregman.md#deepinv.optim.Bregman)
...
As shown in Bolte *et al.*<sup>[1](#footcite-bolte2016descent)</sup>, it is the Bregman potential to use for performing mirror descent on the Poisson likelihood [`deepinv.optim.data_fidelity.PoissonLikelihood`](https://deepinv.org/api/stubs/deepinv.optim.PoissonLikelihood.md#deepinv.optim.PoissonLikelihood).
