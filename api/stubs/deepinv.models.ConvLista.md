...
The architecture was introduced by Simon and Elad<sup>[1](#footcite-simon2019rethinking)</sup>, and it is well suited as a backbone for Poisson2Sparse (see [`deepinv.models.Poisson2Sparse`](https://deepinv.org/api/stubs/deepinv.models.Poisson2Sparse.md#deepinv.models.Poisson2Sparse)).
