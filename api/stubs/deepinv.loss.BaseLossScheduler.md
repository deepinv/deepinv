...
* **Parameters:**
  * **\*loss** ([*Loss*](https://deepinv.org/api/stubs/deepinv.loss.Loss.md#deepinv.loss.Loss)) – loss or multiple losses to be scheduled.
...
* **Parameters:**
  ...
  * **physics** ([*Physics*](https://deepinv.org/api/stubs/deepinv.physics.Physics.md#deepinv.physics.Physics)) – measurement operator
  * **model** ([*torch.nn.Module*](https://docs.pytorch.org/docs/stable/generated/torch.nn.Module.html#torch.nn.Module)) – reconstruction model
...
* **Return type:**
  [list](https://docs.python.org/3.9/library/stdtypes.html#list)[[*Loss*](https://deepinv.org/api/stubs/deepinv.loss.Loss.md#deepinv.loss.Loss)]
