...
* **Parameters:**
  * **transform** ([*deepinv.transform.Transform*](https://deepinv.org/api/stubs/deepinv.transform.Transform.md#deepinv.transform.Transform)) – Transform to generate the virtually augmented measurement.
