...
Bases: [`ScoreSDEDataFidelity`](https://deepinv.org/api/stubs/deepinv.sampling.ScoreSDEDataFidelity.md#deepinv.sampling.ScoreSDEDataFidelity)

Iterative Latent Variable Refinement (ILVR) data-fidelity term.

This corresponds to the $p(y|x_t)$ approximation proposed in
[[28](https://deepinv.org/user_guide/other/biblio.md#id36)], and reviewed in [[37](https://deepinv.org/user_guide/other/biblio.md#id152)]. ILVR is a
preconditioned version of [`deepinv.sampling.ScoreSDEDataFidelity`](https://deepinv.org/api/stubs/deepinv.sampling.ScoreSDEDataFidelity.md#deepinv.sampling.ScoreSDEDataFidelity): the
