...
Bases: [`PSFGenerator`](https://deepinv.org/api/stubs/deepinv.physics.generator.PSFGenerator.md#deepinv.physics.generator.PSFGenerator)
...
of the wavefront aberrations, see [`deepinv.physics.generator.DiffractionBlurGenerator`](https://deepinv.org/api/stubs/deepinv.physics.generator.DiffractionBlurGenerator.md#deepinv.physics.generator.DiffractionBlurGenerator) for more details.
...
#### NOTE
This class uses [`deepinv.physics.generator.DiffractionBlurGenerator`](https://deepinv.org/api/stubs/deepinv.physics.generator.DiffractionBlurGenerator.md#deepinv.physics.generator.DiffractionBlurGenerator) under the hood to generate the pupil function at $z=0$. Refer to its documentation for more details.
...
* **Parameters:**
  ...
  * **kwargs** – additional arguments for [`deepinv.physics.generator.DiffractionBlurGenerator`](https://deepinv.org/api/stubs/deepinv.physics.generator.DiffractionBlurGenerator.md#deepinv.physics.generator.DiffractionBlurGenerator).
...
* **Parameters:**
  ...
  * **coeff** ([*torch.Tensor*](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor)) – tensor containing the Zernike coefficients.
    ...
    [`deepinv.physics.generator.DiffractionBlurGenerator`](https://deepinv.org/api/stubs/deepinv.physics.generator.DiffractionBlurGenerator.md#deepinv.physics.generator.DiffractionBlurGenerator).
