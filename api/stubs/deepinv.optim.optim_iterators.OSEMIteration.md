...
Note that [`deepinv.optim.optim_iterators.MLEMIteration`](https://deepinv.org/api/stubs/deepinv.optim.optim_iterators.MLEMIteration.md#deepinv.optim.optim_iterators.MLEMIteration) is a special case with one subset only.
More details on the algorithm can be found in the documentation of the [`deepinv.optim.optimizers.OSEM`](https://deepinv.org/api/stubs/deepinv.optim.OSEM.md#deepinv.optim.OSEM) optimizer.
...
* **Parameters:**
  ...
  * **cur_data_fidelity** ([*deepinv.optim.DataFidelity*](https://deepinv.org/api/stubs/deepinv.optim.DataFidelity.md#deepinv.optim.DataFidelity)) – Instance of the DataFidelity class defining the current data fidelity.
