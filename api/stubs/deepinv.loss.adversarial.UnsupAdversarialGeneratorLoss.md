...
### *class* deepinv.loss.adversarial.UnsupAdversarialGeneratorLoss(weight_adv=1.0, D=None, device='cpu')
...
Constructs adversarial loss between input measurement and re-measured reconstruction $\hat{y}$, to be minimized by generator.
...
<a id="sphx-glr-backref-deepinv-loss-adversarial-unsupadversarialgeneratorloss"></a>
