...
Bases: [`TVPrior`](https://deepinv.org/api/stubs/deepinv.optim.TVPrior.md#deepinv.optim.TVPrior)
...
A differentiable approximation of [`TVPrior`](https://deepinv.org/api/stubs/deepinv.optim.TVPrior.md#deepinv.optim.TVPrior), where the non-smooth
...
gradient-descent solver inherited from [`Potential`](https://deepinv.org/api/stubs/deepinv.optim.Potential.md#deepinv.optim.Potential).
