...
The method is based on half-quadratic splitting (HQS) and a PnP prior with a pretrained denoiser [`deepinv.models.DRUNet`](https://deepinv.org/api/stubs/deepinv.models.DRUNet.md#deepinv.models.DRUNet).
The optimization is stopped early and the noise level for the denoiser is adapted at each iteration.
See [DPIR method for PnP image deblurring.](https://deepinv.org/auto_examples/plug-and-play/demo_PnP_DPIR_deblur.md#sphx-glr-auto-examples-plug-and-play-demo-pnp-dpir-deblur-py) for more details on the implementation,
...
* **Parameters:**
  ...
  * **denoiser** ([*deepinv.models.Denoiser*](https://deepinv.org/api/stubs/deepinv.models.Denoiser.md#deepinv.models.Denoiser)) – optional denoiser. If `None`, use a pretrained denoiser [`deepinv.models.DRUNet`](https://deepinv.org/api/stubs/deepinv.models.DRUNet.md#deepinv.models.DRUNet).
