...
### *class* deepinv.loss.metric.MAE(complex_abs, reduction, norm_inputs, center_crop, \`\`kwargs\`\`)
...
#### NOTE
[`deepinv.loss.metric.MAE`](#deepinv.loss.metric.MAE) is functionally equivalent to [`torch.nn.L1Loss`](https://docs.pytorch.org/docs/stable/generated/torch.nn.L1Loss.html#torch.nn.L1Loss) when `reduction='mean'` or `reduction='sum'`,
