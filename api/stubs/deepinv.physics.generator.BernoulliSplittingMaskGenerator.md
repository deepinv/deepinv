...
If `input_mask` is None, generates a standard random mask that can be used for [`deepinv.physics.Inpainting`](https://deepinv.org/api/stubs/deepinv.physics.Inpainting.md#deepinv.physics.Inpainting).
