...
it is [`deepinv.physics.DecomposablePhysics`](https://deepinv.org/api/stubs/deepinv.physics.DecomposablePhysics.md#deepinv.physics.DecomposablePhysics) class.
...
* **Parameters:**
  ...
  * **physics** ([*deepinv.physics.DecomposablePhysics*](https://deepinv.org/api/stubs/deepinv.physics.DecomposablePhysics.md#deepinv.physics.DecomposablePhysics)) – the physics operator, which must have a singular value
    decomposition.
