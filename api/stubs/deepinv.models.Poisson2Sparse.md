...
* **Parameters:**
  * **backbone** ([*torch.nn.Module*](https://docs.pytorch.org/docs/stable/generated/torch.nn.Module.html#torch.nn.Module) *,* *None*) – Neural network used as a non-linear dictionary. If `None`, a default [`deepinv.models.ConvLista`](https://deepinv.org/api/stubs/deepinv.models.ConvLista.md#deepinv.models.ConvLista) model is used.
...
<!-- thumbnail-parent-div-open --><div class="sphx-glr-thumbcontainer" tooltip="This code shows how to restore a single image corrupted by Poisson noise using Poisson2Sparse, without requiring external training or knowledge of the noise level.">![](auto_examples/self-supervised-learning/images/thumb/sphx_glr_demo_poisson2sparse_thumb.png)
