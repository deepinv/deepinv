...
#### TIP
All [pretrained denoisers](https://deepinv.org/user_guide/reconstruction/denoisers.md#denoisers) in the library can be re-used for Poisson-Gaussian denoising
using the [`Anscombe transform`](https://deepinv.org/api/stubs/deepinv.models.AnscombeDenoiser.md#deepinv.models.AnscombeDenoiser).
