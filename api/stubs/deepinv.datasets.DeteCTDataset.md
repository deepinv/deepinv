...
Construct geometry objects to pass to [`deepinv.physics.TomographyWithAstra`](https://deepinv.org/api/stubs/deepinv.physics.TomographyWithAstra.md#deepinv.physics.TomographyWithAstra)
