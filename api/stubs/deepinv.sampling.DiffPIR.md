...
* **Parameters:**
  ...
  * **data_fidelity** ([*deepinv.optim.DataFidelity*](https://deepinv.org/api/stubs/deepinv.optim.DataFidelity.md#deepinv.optim.DataFidelity)) – the data fidelity operator
...
* **Parameters:**
  ...
  * **physics** ([*deepinv.physics.LinearPhysics*](https://deepinv.org/api/stubs/deepinv.physics.LinearPhysics.md#deepinv.physics.LinearPhysics)) – the physics operator.
  * **sigma** ([*float*](https://docs.python.org/3.9/library/functions.html#float)) – the noise level of the data.
