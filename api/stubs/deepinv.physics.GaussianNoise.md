...
1. If `other` is a [`NoiseModel`](https://deepinv.org/api/stubs/deepinv.physics.NoiseModel.md#deepinv.physics.NoiseModel), then applies the multiplication from `NoiseModel`.
