...
More details on the algorithm can be found in the documentation of the [`deepinv.optim.optimizers.MLEM`](https://deepinv.org/api/stubs/deepinv.optim.MLEM.md#deepinv.optim.MLEM) optimizer.
...
* **Parameters:**
  ...
  * **physics** ([*deepinv.physics.Physics*](https://deepinv.org/api/stubs/deepinv.physics.Physics.md#deepinv.physics.Physics)) – Instance of the physics modeling the data-fidelity term.
