...
[`generalized_anscombe_transform()`](https://deepinv.org/api/stubs/deepinv.models.generalized_anscombe_transform.md#deepinv.models.generalized_anscombe_transform)) back to the original
[`Poisson-Gaussian`](https://deepinv.org/api/stubs/deepinv.physics.PoissonGaussianNoise.md#deepinv.physics.PoissonGaussianNoise) domain with
gain $\gamma$ and [`Gaussian noise`](https://deepinv.org/api/stubs/deepinv.physics.GaussianNoise.md#deepinv.physics.GaussianNoise)
...
[`generalized_anscombe_transform()`](https://deepinv.org/api/stubs/deepinv.models.generalized_anscombe_transform.md#deepinv.models.generalized_anscombe_transform):
