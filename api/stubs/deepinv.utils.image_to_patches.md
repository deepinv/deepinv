...
The behavior mirrors [`deepinv.utils.TiledMixin2d`](https://deepinv.org/api/stubs/deepinv.utils.TiledMixin2d.md#deepinv.utils.TiledMixin2d) while exposing a functional API.
...
![image](../../_build/plot_directive/api/stubs/deepinv-utils-image_to_patches-1.png)
