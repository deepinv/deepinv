...
using [`deepinv.optim.prior.GLOWCouplingBlock`](https://deepinv.org/api/stubs/deepinv.optim.prior.GLOWCouplingBlock.md#deepinv.optim.prior.GLOWCouplingBlock) as the building block.
