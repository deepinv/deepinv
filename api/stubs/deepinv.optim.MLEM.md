...
(standard MLEM). See [`deepinv.optim.optim_iterators.MLEMIteration`](https://deepinv.org/api/stubs/deepinv.optim.optim_iterators.MLEMIteration.md#deepinv.optim.optim_iterators.MLEMIteration) for the details of the iteration.
