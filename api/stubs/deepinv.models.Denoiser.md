...
#### NOTE
A Denoiser can be converted into a [`Reconstructor`](https://deepinv.org/api/stubs/deepinv.models.Reconstructor.md#deepinv.models.Reconstructor)
by using the [`deepinv.models.ArtifactRemoval`](https://deepinv.org/api/stubs/deepinv.models.ArtifactRemoval.md#deepinv.models.ArtifactRemoval) class.
