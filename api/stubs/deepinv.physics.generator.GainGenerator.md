...
Generator for the noise level $\gamma$ in the [`Poisson noise model`](https://deepinv.org/api/stubs/deepinv.physics.PoissonNoise.md#deepinv.physics.PoissonNoise).
