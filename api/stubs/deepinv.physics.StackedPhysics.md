...
* **Parameters:**
  * **noise_model** (*Callable* *,* [*deepinv.physics.NoiseModel*](https://deepinv.org/api/stubs/deepinv.physics.NoiseModel.md#deepinv.physics.NoiseModel)) – noise model for the physics operator.
