...
Bases: [`SupLoss`](https://deepinv.org/api/stubs/deepinv.loss.SupLoss.md#deepinv.loss.SupLoss)
...
#### HINT
During training, consider using the `compute_train_metrics=False` option in [`deepinv.Trainer`](https://deepinv.org/api/stubs/deepinv.Trainer.md#deepinv.Trainer) to prevent a shape
...
* **Parameters:**
  ...
  * **physics** ([*Physics*](https://deepinv.org/api/stubs/deepinv.physics.Physics.md#deepinv.physics.Physics)) – optional physics to perform reduced resolution measurement. If not specified, take the physics from the forward pass.
