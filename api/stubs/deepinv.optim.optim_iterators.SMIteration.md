...
Iterator for Spectral Methods for [`deepinv.physics.PhaseRetrieval`](https://deepinv.org/api/stubs/deepinv.physics.PhaseRetrieval.md#deepinv.physics.PhaseRetrieval).
...
* **Parameters:**
  ...
  * **physics** ([*deepinv.physics.Physics*](https://deepinv.org/api/stubs/deepinv.physics.Physics.md#deepinv.physics.Physics)) – Instance of the physics containing the forward operator.
* **Returns:**
