...
The DRS iterations are defined in the iterator class [`deepinv.optim.optim_iterators.DRSIteration`](https://deepinv.org/api/stubs/deepinv.optim.optim_iterators.DRSIteration.md#deepinv.optim.optim_iterators.DRSIteration).
