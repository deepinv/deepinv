...
Bases: [`Reconstructor`](https://deepinv.org/api/stubs/deepinv.models.Reconstructor.md#deepinv.models.Reconstructor), [`TimeMixin`](https://deepinv.org/api/stubs/deepinv.utils.TimeMixin.md#deepinv.utils.TimeMixin)
...
* **Parameters:**
  ...
  * **physics** ([*Physics*](https://deepinv.org/api/stubs/deepinv.physics.Physics.md#deepinv.physics.Physics)) – forward operator acting on dynamic inputs
