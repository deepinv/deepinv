...
Bases: [`Module`](https://docs.pytorch.org/docs/stable/generated/torch.nn.Module.html#torch.nn.Module), [`TimeMixin`](https://deepinv.org/api/stubs/deepinv.utils.TimeMixin.md#deepinv.utils.TimeMixin)
...
It must either implement a `to_static` method to remove the time dimension, or already be a static physics (e.g. [`deepinv.physics.MRI`](https://deepinv.org/api/stubs/deepinv.physics.MRI.md#deepinv.physics.MRI)).
