...
proximal gradient iteration, the ADMM iteration, see [Predefined Algorithms](https://deepinv.org/user_guide/reconstruction/optimization.md#optim-iterators)), that is
for $k=1,2,...$
...
* **Examples:**
  ...
  ```
* **Parameters:**
  * **iterator** ([*deepinv.optim.OptimIterator*](https://deepinv.org/api/stubs/deepinv.optim.OptimIterator.md#deepinv.optim.OptimIterator)) – function that takes as input the current iterate, as
  ...
  * **anderson_acceleration_config** ([*deepinv.optim.AndersonAccelerationConfig*](https://deepinv.org/api/stubs/deepinv.optim.AndersonAccelerationConfig.md#deepinv.optim.AndersonAccelerationConfig)) – parameters for Anderson acceleration of the fixed-point iterations.
  * **backtracking_config** ([*deepinv.optim.BacktrackingConfig*](https://deepinv.org/api/stubs/deepinv.optim.BacktrackingConfig.md#deepinv.optim.BacktrackingConfig)) – parameters for backtracking line-search stepsize strategy.
...
* **Parameters:**
  ...
  * **cur_data_fidelity** ([*deepinv.optim.DataFidelity*](https://deepinv.org/api/stubs/deepinv.optim.DataFidelity.md#deepinv.optim.DataFidelity)) – Instance of the DataFidelity class defining the current data_fidelity.
  * **cur_prior** ([*deepinv.optim.Prior*](https://deepinv.org/api/stubs/deepinv.optim.Prior.md#deepinv.optim.Prior)) – Instance of the Prior class defining the current prior.
