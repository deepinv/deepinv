...
Takes input measurements as a [`deepinv.utils.TensorList`](https://deepinv.org/api/stubs/deepinv.utils.TensorList.md#deepinv.utils.TensorList) with elements (MS, PAN),
...
* **Return dinv.physics.Physics:**
  deepinv sampler
* **Return type:**
  [*Physics*](https://deepinv.org/api/stubs/deepinv.physics.Physics.md#deepinv.physics.Physics)
...
* **Parameters:**
  * **y** ([*deepinv.utils.TensorList*](https://deepinv.org/api/stubs/deepinv.utils.TensorList.md#deepinv.utils.TensorList)) – (MS,PAN) images
  * **physics** ([*deepinv.physics.Pansharpen*](https://deepinv.org/api/stubs/deepinv.physics.Pansharpen.md#deepinv.physics.Pansharpen)) – Pansharpening operator
