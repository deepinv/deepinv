...
* **Parameters:**
  ...
  * **strategy** ([*DistributedSignalStrategy*](https://deepinv.org/api/stubs/deepinv.distributed.strategies.DistributedSignalStrategy.md#deepinv.distributed.strategies.DistributedSignalStrategy) *|* *None*) – signal processing strategy for patch extraction
