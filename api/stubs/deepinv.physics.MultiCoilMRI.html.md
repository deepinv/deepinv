...
* **Parameters:**
  ...
  * **smooth** ([*float*](https://docs.python.org/3.9/library/functions.html#float)) – low-pass width applied to x_hat phase as a fraction of image size. Larger keeps only smoother phase.
* **Returns:**
  updated coil maps.
...
</div><div class="sphx-glr-thumbcontainer" tooltip="This example reconstructs raw non-Cartesian multicoil kspace data from the FastMRI breast dataset :footcitesolomonFastMRI2025, for mammography.">  <div class="sphx-glr-thumbnail-title">Reconstruct accelerated non-Cartesian breast MRI acquisition data</div>
