...
The reconstruction function is based on the approximated half-quadratic splitting method as in Zoran and Weiss [[203](https://deepinv.org/user_guide/other/biblio.md#id41)].

* **Parameters:**
  * **GMM** (*None* *,* [*deepinv.optim.utils.GaussianMixtureModel*](https://deepinv.org/api/stubs/deepinv.optim.utils.GaussianMixtureModel.md#deepinv.optim.utils.GaussianMixtureModel)) – Gaussian mixture defining the distribution on the patch space.
  ...
  * **pretrained** ([*str*](https://docs.python.org/3.9/library/stdtypes.html#str) *,* *None*) – Path to pretrained weights of the GMM with file ending `.pt`. None for no pretrained weights,
    ...
    See [pretrained-weights](https://deepinv.org/user_guide/reconstruction/pretrained-models.md#pretrained-weights) for more details.
...
* **Parameters:**
  ...
  * **physics** ([*deepinv.physics.LinearPhysics*](https://deepinv.org/api/stubs/deepinv.physics.LinearPhysics.md#deepinv.physics.LinearPhysics)) – Forward linear operator.
