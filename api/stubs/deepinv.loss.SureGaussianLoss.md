...
* **Parameters:**
  ...
  * **B** (*Callable* *,* [*str*](https://docs.python.org/3.9/library/stdtypes.html#str)) – Optional linear metric $B$, which can be used to improve
    ...
    such as [`deepinv.physics.LinearPhysics.prox_l2()`](https://deepinv.org/api/stubs/deepinv.physics.LinearPhysics.md#deepinv.physics.LinearPhysics.prox_l2) with large $\gamma$. By default, the identity is used.
