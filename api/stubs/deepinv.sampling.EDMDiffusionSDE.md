...
Bases: [`DiffusionSDE`](https://deepinv.org/api/stubs/deepinv.sampling.DiffusionSDE.md#deepinv.sampling.DiffusionSDE)
...
* **Parameters:**
  ...
  * **solver** ([*deepinv.sampling.BaseSDESolver*](https://deepinv.org/api/stubs/deepinv.sampling.BaseSDESolver.md#deepinv.sampling.BaseSDESolver)) – the solver for solving the SDE. Default to `None`.
