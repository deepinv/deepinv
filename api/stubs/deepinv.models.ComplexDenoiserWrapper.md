...
* **Examples:**
  ...
  ```
* **Parameters:**
  * **denoiser** ([*deepinv.models.Denoiser*](https://deepinv.org/api/stubs/deepinv.models.Denoiser.md#deepinv.models.Denoiser)) – Real-valued denoiser $\denoisername$ to wrap.
