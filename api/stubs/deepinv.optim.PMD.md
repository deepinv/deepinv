...
$\operatorname{prox^h}_{\gamma \lambda \regname}$ is the Bregman proximal operator, detailed in the method [`deepinv.optim.Potential.bregman_prox()`](https://deepinv.org/api/stubs/deepinv.optim.Potential.md#deepinv.optim.Potential.bregman_prox).
The Proximal Mirror Descent iterations are defined in the iterator class [`deepinv.optim.optim_iterators.PMDIteration`](https://deepinv.org/api/stubs/deepinv.optim.optim_iterators.PMDIteration.md#deepinv.optim.optim_iterators.PMDIteration).
...
* **Parameters:**
  * **bregman_potential** ([*deepinv.optim.Bregman*](https://deepinv.org/api/stubs/deepinv.optim.Bregman.md#deepinv.optim.Bregman)) – Bregman potential used for Bregman optimization algorithms such as Proximal Mirror Descent. Default: `BregmanL2()`.
