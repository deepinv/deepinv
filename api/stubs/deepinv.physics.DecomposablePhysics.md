...
* **Parameters:**
  ...
  * **U_adjoint** (*None* *|* *Callable*) – transpose of U. If `None` (default), it is computed automatically using [`deepinv.physics.adjoint_function()`](https://deepinv.org/api/stubs/deepinv.physics.adjoint_function.md#deepinv.physics.adjoint_function)
  ...
  * **V** (*None* *|* *Callable*) – If `None` (default), it is computed automatically using [`deepinv.physics.adjoint_function()`](https://deepinv.org/api/stubs/deepinv.physics.adjoint_function.md#deepinv.physics.adjoint_function)
