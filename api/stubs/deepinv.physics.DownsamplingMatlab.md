...
Bases: [`Downsampling`](https://deepinv.org/api/stubs/deepinv.physics.Downsampling.md#deepinv.physics.Downsampling)
...
The adjoint is computed using autograd via [`deepinv.physics.adjoint_function()`](https://deepinv.org/api/stubs/deepinv.physics.adjoint_function.md#deepinv.physics.adjoint_function).
