...
To handle standard PyTorch pipelines, [`XrayTransform`](#deepinv.physics.functional.XrayTransform) is instantiated inside a [`deepinv.physics.TomographyWithAstra`](https://deepinv.org/api/stubs/deepinv.physics.TomographyWithAstra.md#deepinv.physics.TomographyWithAstra) operator.
