...
* **Parameters:**
  **bregman_potential** ([*deepinv.optim.Bregman*](https://deepinv.org/api/stubs/deepinv.optim.Bregman.md#deepinv.optim.Bregman)) – Instance of the Bregman class defining the Bregman potential used to compute the mirror descent step.
...
* **Parameters:**
  ...
  * **physics** ([*deepinv.physics.Physics*](https://deepinv.org/api/stubs/deepinv.physics.Physics.md#deepinv.physics.Physics)) – Instance of the `Physics` class defining the current physics.
* **Returns:**
