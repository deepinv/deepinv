...
The transposed of this operation is [`deepinv.physics.functional.conv3d()`](https://deepinv.org/api/stubs/deepinv.physics.functional.conv3d.md#deepinv.physics.functional.conv3d).
