...
The linear operator $B$ is defined by a [`deepinv.physics.LinearPhysics`](https://deepinv.org/api/stubs/deepinv.physics.LinearPhysics.md#deepinv.physics.LinearPhysics) object.
...
* **Parameters:**
  **B** ([*deepinv.physics.forward.LinearPhysics*](https://deepinv.org/api/stubs/deepinv.physics.LinearPhysics.md#deepinv.physics.LinearPhysics)) – the linear forward operator.
...
We use the spectral methods defined in [`deepinv.optim.phase_retrieval.spectral_methods`](https://deepinv.org/api/stubs/deepinv.optim.phase_retrieval.spectral_methods.md#deepinv.optim.phase_retrieval.spectral_methods) to obtain an initial inverse.
