...
Bases: [`ComposedPhysics`](https://deepinv.org/api/stubs/deepinv.physics.ComposedPhysics.md#deepinv.physics.ComposedPhysics), [`LinearPhysics`](https://deepinv.org/api/stubs/deepinv.physics.LinearPhysics.md#deepinv.physics.LinearPhysics)
...
* **Parameters:**
  **physics** (*Iterable* *[*[*deepinv.physics.LinearPhysics*](https://deepinv.org/api/stubs/deepinv.physics.LinearPhysics.md#deepinv.physics.LinearPhysics) *]*) – variable number of physics to compose.
