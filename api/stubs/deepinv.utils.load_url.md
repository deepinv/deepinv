...
[`deepinv.utils.load_torch()`](https://deepinv.org/api/stubs/deepinv.utils.load_torch.md#deepinv.utils.load_torch), [`deepinv.utils.load_np()`](https://deepinv.org/api/stubs/deepinv.utils.load_np.md#deepinv.utils.load_np) etc.
to load data directly from a URL.

Downloaded content is cached under [`deepinv.utils.get_cache_home()`](https://deepinv.org/api/stubs/deepinv.utils.get_cache_home.md#deepinv.utils.get_cache_home)
...
[`deepinv.utils.DownloadError`](https://deepinv.org/api/stubs/deepinv.utils.DownloadError.md#deepinv.utils.DownloadError) rather than blocking indefinitely.
...
* **Returns:**
  `BytesIO` buffer.
* **Raises:**
  [**deepinv.utils.DownloadError**](https://deepinv.org/api/stubs/deepinv.utils.DownloadError.md#deepinv.utils.DownloadError) – if the file cannot be downloaded.
* **Return type:**
