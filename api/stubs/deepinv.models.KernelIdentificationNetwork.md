...
the parameters of [`deepinv.physics.SpaceVaryingBlur`](https://deepinv.org/api/stubs/deepinv.physics.SpaceVaryingBlur.md#deepinv.physics.SpaceVaryingBlur) forward model, i.e., blur kernels and corresponding spatial multipliers (masks).
