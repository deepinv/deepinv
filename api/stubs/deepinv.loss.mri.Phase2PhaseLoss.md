...
Bases: [`SplittingLoss`](https://deepinv.org/api/stubs/deepinv.loss.SplittingLoss.md#deepinv.loss.SplittingLoss)
...
This is a special (temporal) case of the generic splitting loss: see [`deepinv.loss.SplittingLoss`](https://deepinv.org/api/stubs/deepinv.loss.SplittingLoss.md#deepinv.loss.SplittingLoss) for more details.
...
#### WARNING
The model should be adapted before training using the method [`adapt_model`](https://deepinv.org/api/stubs/deepinv.loss.SplittingLoss.md#deepinv.loss.SplittingLoss.adapt_model)
...
#### NOTE
Phase2Phase can be used to reconstruct video sequences by setting `dynamic_model=True` and using physics [`deepinv.physics.DynamicMRI`](https://deepinv.org/api/stubs/deepinv.physics.DynamicMRI.md#deepinv.physics.DynamicMRI).
...
To do this, set `dynamic_model=False` and use physics [`deepinv.physics.SequentialMRI`](https://deepinv.org/api/stubs/deepinv.physics.SequentialMRI.md#deepinv.physics.SequentialMRI). See below for example or [Self-supervised MRI reconstruction with Artifact2Artifact](https://deepinv.org/auto_examples/self-supervised-learning/demo_artifact2artifact.md#sphx-glr-auto-examples-self-supervised-learning-demo-artifact2artifact-py) for full MRI example.
...
* **Parameters:**
  **model** ([*deepinv.models.Reconstructor*](https://deepinv.org/api/stubs/deepinv.models.Reconstructor.md#deepinv.models.Reconstructor) *,* [*torch.nn.Module*](https://docs.pytorch.org/docs/stable/generated/torch.nn.Module.html#torch.nn.Module)) – Reconstruction model.
* **Returns:**
  ([`deepinv.loss.SplittingLoss.SplittingModel`](https://deepinv.org/api/stubs/deepinv.loss.SplittingLoss.md#deepinv.loss.SplittingLoss.SplittingModel)) Model modified for evaluation.
* **Return type:**
  [*SplittingModel*](https://deepinv.org/api/stubs/deepinv.loss.SplittingLoss.md#deepinv.loss.SplittingLoss.SplittingModel)
...
* **Parameters:**
  ...
  * **physics** ([*deepinv.physics.Physics*](https://deepinv.org/api/stubs/deepinv.physics.Physics.md#deepinv.physics.Physics)) – forward physics
