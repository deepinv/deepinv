...
#### NOTE
The argument `sigma` is included for compatibility with the base class [`Denoiser`](https://deepinv.org/api/stubs/deepinv.models.Denoiser.md#deepinv.models.Denoiser) but is not used in this model.
