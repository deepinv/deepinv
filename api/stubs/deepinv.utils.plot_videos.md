...
This is useful for e.g. time-varying inverse problems. Individual frames are plotted with [`deepinv.utils.plot()`](https://deepinv.org/api/stubs/deepinv.utils.plot.md#deepinv.utils.plot)

Plots videos as sequence of side-by-side frames, and saves animation (e.g. GIF) or displays as interactive HTML in notebook. This is useful for e.g. time-varying inverse problems. Individual frames are plotted with [`deepinv.utils.plot()`](https://deepinv.org/api/stubs/deepinv.utils.plot.md#deepinv.utils.plot)
...
Per frame of the videos, this function calls [`deepinv.utils.plot()`](https://deepinv.org/api/stubs/deepinv.utils.plot.md#deepinv.utils.plot), see its params to see how the frames are plotted.
...
* **Parameters:**
  ...
  * **rescale_mode** ([*str*](https://docs.python.org/3.9/library/stdtypes.html#str)) – rescaling mode for [`deepinv.utils.plot()`](https://deepinv.org/api/stubs/deepinv.utils.plot.md#deepinv.utils.plot), defaults to `"min_max"`
  ...
  * **rescale_mode** – rescaling mode for [`deepinv.utils.plot()`](https://deepinv.org/api/stubs/deepinv.utils.plot.md#deepinv.utils.plot), defaults to `"min_max"`
  ...
  * **plot_kwargs** ([*dict*](https://docs.python.org/3.9/library/stdtypes.html#dict)) – kwargs to pass to [`deepinv.utils.plot()`](https://deepinv.org/api/stubs/deepinv.utils.plot.md#deepinv.utils.plot)
