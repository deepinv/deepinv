...
In this case, we recommend using [`deepinv.physics.StructuredRandom`](https://deepinv.org/api/stubs/deepinv.physics.StructuredRandom.md#deepinv.physics.StructuredRandom) instead.
