...
> - Physics operators: a list of [`deepinv.physics.Physics`](https://deepinv.org/api/stubs/deepinv.physics.Physics.md#deepinv.physics.Physics), [`deepinv.physics.StackedPhysics`](https://deepinv.org/api/stubs/deepinv.physics.StackedPhysics.md#deepinv.physics.StackedPhysics) or [`deepinv.physics.StackedLinearPhysics`](https://deepinv.org/api/stubs/deepinv.physics.StackedLinearPhysics.md#deepinv.physics.StackedLinearPhysics).
> - Data fidelity terms: a list of [`deepinv.optim.DataFidelity`](https://deepinv.org/api/stubs/deepinv.optim.DataFidelity.md#deepinv.optim.DataFidelity) or [`deepinv.optim.StackedPhysicsDataFidelity`](https://deepinv.org/api/stubs/deepinv.optim.StackedPhysicsDataFidelity.md#deepinv.optim.StackedPhysicsDataFidelity).
> - Priors/Denoisers: [`deepinv.models.Denoiser`](https://deepinv.org/api/stubs/deepinv.models.Denoiser.md#deepinv.models.Denoiser) or [`deepinv.optim.Prior`](https://deepinv.org/api/stubs/deepinv.optim.Prior.md#deepinv.optim.Prior) objects.
* **Parameters:**
  * **object** ([*StackedPhysics*](https://deepinv.org/api/stubs/deepinv.physics.StackedPhysics.md#deepinv.physics.StackedPhysics) *|* [*list*](https://docs.python.org/3.9/library/stdtypes.html#list) *[*[*Physics*](https://deepinv.org/api/stubs/deepinv.physics.Physics.md#deepinv.physics.Physics) *]*  *|* *Callable* *|* [*Denoiser*](https://deepinv.org/api/stubs/deepinv.models.Denoiser.md#deepinv.models.Denoiser) *|* [*DataFidelity*](https://deepinv.org/api/stubs/deepinv.optim.DataFidelity.md#deepinv.optim.DataFidelity) *|* [*StackedPhysicsDataFidelity*](https://deepinv.org/api/stubs/deepinv.optim.StackedPhysicsDataFidelity.md#deepinv.optim.StackedPhysicsDataFidelity) *|* [*list*](https://docs.python.org/3.9/library/stdtypes.html#list) *[*[*DataFidelity*](https://deepinv.org/api/stubs/deepinv.optim.DataFidelity.md#deepinv.optim.DataFidelity) *]*  *|* [*torch.nn.Module*](https://docs.pytorch.org/docs/stable/generated/torch.nn.Module.html#torch.nn.Module) *|* [*torch.nn.parameter.Parameter*](https://docs.pytorch.org/docs/stable/generated/torch.nn.parameter.Parameter.html#torch.nn.parameter.Parameter) *|* *Sequence* *[*[*torch.nn.parameter.Parameter*](https://docs.pytorch.org/docs/stable/generated/torch.nn.parameter.Parameter.html#torch.nn.parameter.Parameter) *]*) – DeepInverse object to distribute.
  * **ctx** ([*DistributedContext*](https://deepinv.org/api/stubs/deepinv.distributed.DistributedContext.md#deepinv.distributed.DistributedContext)) – distributed context manager.
  ...
  * **type_object** ([*str*](https://docs.python.org/3.9/library/stdtypes.html#str) *|* *None*) – type of object to distribute. Options are `'physics'`, `'linear_physics'`,
    ...
    Default is `'auto'`.
    `'module'` is restricted to [`BaseOptim`](https://deepinv.org/api/stubs/deepinv.optim.BaseOptim.md#deepinv.optim.BaseOptim) models built
  ...
  * **tiling_strategy** ([*DistributedSignalStrategy*](https://deepinv.org/api/stubs/deepinv.distributed.strategies.DistributedSignalStrategy.md#deepinv.distributed.strategies.DistributedSignalStrategy) *|* *None*) – strategy for tiling the signal (for Denoiser).
