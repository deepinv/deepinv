...
[`Generalized Anscombe Transform (GAT)`](https://deepinv.org/api/stubs/deepinv.models.generalized_anscombe_transform.md#deepinv.models.generalized_anscombe_transform)
...
[`Poisson-Gaussian noise`](https://deepinv.org/api/stubs/deepinv.physics.PoissonGaussianNoise.md#deepinv.physics.PoissonGaussianNoise) with gain $\gamma$
...
* **Parameters:**
  **denoiser** ([*deepinv.models.Denoiser*](https://deepinv.org/api/stubs/deepinv.models.Denoiser.md#deepinv.models.Denoiser)) – Gaussian denoiser $\denoisername$ to wrap.
...
![image](../../_build/plot_directive/api/stubs/deepinv-models-AnscombeDenoiser-1.png)
