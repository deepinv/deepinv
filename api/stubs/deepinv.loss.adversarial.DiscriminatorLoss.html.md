...
For examples, see [`deepinv.loss.adversarial.SupAdversarialDiscriminatorLoss`](https://deepinv.org/api/stubs/deepinv.loss.adversarial.SupAdversarialDiscriminatorLoss.html.md#deepinv.loss.adversarial.SupAdversarialDiscriminatorLoss),
[`deepinv.loss.adversarial.UnsupAdversarialDiscriminatorLoss`](https://deepinv.org/api/stubs/deepinv.loss.adversarial.UnsupAdversarialDiscriminatorLoss.html.md#deepinv.loss.adversarial.UnsupAdversarialDiscriminatorLoss).
