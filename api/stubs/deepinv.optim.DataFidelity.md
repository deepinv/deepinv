...
from the class [`deepinv.optim.Distance`](https://deepinv.org/api/stubs/deepinv.optim.Distance.md#deepinv.optim.Distance).
...
* **Parameters:**
  **d** (*Callable*) – distance function $d(x, y)$ between a variable $x$ and an observation $y$.
  ...
  [`deepinv.optim.L2`](https://deepinv.org/api/stubs/deepinv.optim.L2.md#deepinv.optim.L2).
...
#### WARNING
If $\phi$ is the squared Euclidean norm ([`deepinv.optim.BregmanL2`](https://deepinv.org/api/stubs/deepinv.optim.BregmanL2.md#deepinv.optim.BregmanL2)), this operator
...
* **Parameters:**
  ...
  * **bregman_potential** ([*deepinv.optim.Bregman*](https://deepinv.org/api/stubs/deepinv.optim.Bregman.md#deepinv.optim.Bregman)) – Bregman potential $\phi$ to be used in the Bregman proximity operator.
