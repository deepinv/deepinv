...
Subgroup transformations include [`deepinv.transform.projective.Affine`](https://deepinv.org/api/stubs/deepinv.transform.projective.Affine.md#deepinv.transform.projective.Affine), [`deepinv.transform.projective.Similarity`](https://deepinv.org/api/stubs/deepinv.transform.projective.Similarity.md#deepinv.transform.projective.Similarity),
[`deepinv.transform.projective.Euclidean`](https://deepinv.org/api/stubs/deepinv.transform.projective.Euclidean.md#deepinv.transform.projective.Euclidean) along with the basic [`deepinv.transform.Shift`](https://deepinv.org/api/stubs/deepinv.transform.Shift.md#deepinv.transform.Shift),
[`deepinv.transform.Rotate`](https://deepinv.org/api/stubs/deepinv.transform.Rotate.md#deepinv.transform.Rotate) and semigroup [`deepinv.transform.Scale`](https://deepinv.org/api/stubs/deepinv.transform.Scale.md#deepinv.transform.Scale).
