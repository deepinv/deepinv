...
The adjoint of this operation is [`deepinv.physics.functional.conv2d_fft()`](https://deepinv.org/api/stubs/deepinv.physics.functional.conv2d_fft.md#deepinv.physics.functional.conv2d_fft).
...
#### NOTE
This functions gives the same result as [`deepinv.physics.functional.conv_transpose2d()`](https://deepinv.org/api/stubs/deepinv.physics.functional.conv_transpose2d.md#deepinv.physics.functional.conv_transpose2d).
However, for large kernels, this function is faster but requires more memory.
For small kernels, consider using [`deepinv.physics.functional.conv_transpose2d()`](https://deepinv.org/api/stubs/deepinv.physics.functional.conv_transpose2d.md#deepinv.physics.functional.conv_transpose2d).
