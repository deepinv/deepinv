...
Bases: [`ALDDataFidelity`](https://deepinv.org/api/stubs/deepinv.sampling.ALDDataFidelity.md#deepinv.sampling.ALDDataFidelity)

Score-SDE data-fidelity term.

This corresponds to the $p(y|x_t)$ approximation proposed in
[[154](https://deepinv.org/user_guide/other/biblio.md#id111)], and reviewed in [[37](https://deepinv.org/user_guide/other/biblio.md#id152)]. The difference with
[`deepinv.sampling.ALDDataFidelity`](https://deepinv.org/api/stubs/deepinv.sampling.ALDDataFidelity.md#deepinv.sampling.ALDDataFidelity) is that the measurements are noised to the
...
#### NOTE
[[37](https://deepinv.org/user_guide/other/biblio.md#id152)] writes this approximation without a guidance strength,
noting that it then differs from [`deepinv.sampling.ALDDataFidelity`](https://deepinv.org/api/stubs/deepinv.sampling.ALDDataFidelity.md#deepinv.sampling.ALDDataFidelity) only
