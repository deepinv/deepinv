...
Bases: [`L2`](https://deepinv.org/api/stubs/deepinv.optim.L2.md#deepinv.optim.L2)
...
It is designed to be used in conjunction with the [`deepinv.physics.SpatialUnwrapping`](https://deepinv.org/api/stubs/deepinv.physics.SpatialUnwrapping.md#deepinv.physics.SpatialUnwrapping) class for spatial unwrapping tasks.
