...
where $\gamma>0$ is a stepsize. The Gradient Descent iterations are defined in the iterator class [`deepinv.optim.optim_iterators.GDIteration`](https://deepinv.org/api/stubs/deepinv.optim.optim_iterators.GDIteration.md#deepinv.optim.optim_iterators.GDIteration).
