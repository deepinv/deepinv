...
More details on the algorithm can be found in the documentation of the [`deepinv.optim.optimizers.OSEM`](https://deepinv.org/api/stubs/deepinv.optim.OSEM.html.md#deepinv.optim.OSEM) optimizer.
