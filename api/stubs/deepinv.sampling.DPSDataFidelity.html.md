...
This corresponds to the $p(y|x_t)$ approximation proposed in [[27](https://deepinv.org/user_guide/other/biblio.html.md#id65)].
...
`guidance="norm"` (the default) follows [[27](https://deepinv.org/user_guide/other/biblio.html.md#id65)] and normalizes
...
* **Parameters:**
  ...
  * **guidance** ([*str*](https://docs.python.org/3.9/library/stdtypes.html#str)) – Either `"norm"` (default), the residual norm of
    [[27](https://deepinv.org/user_guide/other/biblio.html.md#id65)], or `"annealed"`, the Gaussian negative
