...
- `'aesthetic'` (default), trained on the AVA dataset [[111](https://deepinv.org/user_guide/other/biblio.html.md#id154)], which rates the aesthetic appeal of an image;
- `'technical'`, trained on the TID2013 dataset [[121](https://deepinv.org/user_guide/other/biblio.html.md#id153)], which rates the amount of distortion in an image
