...
The adjoint of this operation is [`deepinv.physics.functional.conv3d_fft()`](https://deepinv.org/api/stubs/deepinv.physics.functional.conv3d_fft.md#deepinv.physics.functional.conv3d_fft).
...
#### NOTE
This function and [`deepinv.physics.functional.conv_transpose3d()`](https://deepinv.org/api/stubs/deepinv.physics.functional.conv_transpose3d.md#deepinv.physics.functional.conv_transpose3d) are equivalent. However, this function is more efficient for large filters.
