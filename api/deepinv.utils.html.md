...
**User Guide:** refer to [Signal Processing](https://deepinv.org/user_guide/other/utils.html.md#signal-processing) for more information.

| [`deepinv.utils.hilbert`](https://deepinv.org/api/stubs/deepinv.utils.hilbert.html.md#deepinv.utils.hilbert)   | Compute the analytical signal via Hilbert transform.   |
|------------------------------------------------------------------------------------------------|--------------------------------------------------------|
| [`deepinv.utils.bmode`](https://deepinv.org/api/stubs/deepinv.utils.bmode.html.md#deepinv.utils.bmode)       | Compute log-compressed brightness mode (B-Mode) image. |
...
| [`deepinv.utils.load_blosc2`](https://deepinv.org/api/stubs/deepinv.utils.load_blosc2.html.md#deepinv.utils.load_blosc2)           | Load volume from blosc2 file as torch tensor.                       |
...
| [`deepinv.utils.load_ismrmrd_raw`](https://deepinv.org/api/stubs/deepinv.utils.load_ismrmrd_raw.html.md#deepinv.utils.load_ismrmrd_raw) | Load ISMRMRD hdf5 raw Cartesian multi-coil MRI data.                |
