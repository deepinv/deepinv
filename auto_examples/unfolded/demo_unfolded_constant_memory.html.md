...
```none
Selected GPU 0 with 4213.25 MiB free memory
```
...
```none
Full backpropagation: time per iteration: 1.55 s.
Implicit differentiation: time per iteration: 1.39 s.
...
**Total running time of the script:** (0 minutes 45.003 seconds)
