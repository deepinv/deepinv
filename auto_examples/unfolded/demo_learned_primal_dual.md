...
The iterator is a subclass of the Chambolle-Pock iterator [`deepinv.optim.optim_iterators.CPIteration`](https://deepinv.org/api/stubs/deepinv.optim.optim_iterators.CPIteration.md#deepinv.optim.optim_iterators.CPIteration).
...
Prior and data-fidelity are respectively defined as subclass of [`deepinv.optim.Prior`](https://deepinv.org/api/stubs/deepinv.optim.Prior.md#deepinv.optim.Prior) and [`deepinv.optim.DataFidelity`](https://deepinv.org/api/stubs/deepinv.optim.DataFidelity.md#deepinv.optim.DataFidelity).
