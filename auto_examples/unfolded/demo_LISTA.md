...
The proximal gradient iteration (see also [`deepinv.optim.optim_iterators.PGDIteration`](https://deepinv.org/api/stubs/deepinv.optim.optim_iterators.PGDIteration.md#deepinv.optim.optim_iterators.PGDIteration)) is defined as
...
which corresponds to soft-thresholding with a wavelet basis (see [`deepinv.optim.WaveletPrior`](https://deepinv.org/api/stubs/deepinv.optim.WaveletPrior.md#deepinv.optim.WaveletPrior)).

We use [`deepinv.optim.PGD()`](https://deepinv.org/api/stubs/deepinv.optim.PGD.md#deepinv.optim.PGD)  with `unfold=True` to define the unfolded algorithm
...
Eval epoch 0: PSNR=14.13
Best model saved at epoch 1
Train epoch 1: TotalLoss=0.052, PSNR=13.131
Eval epoch 1: PSNR=14.265
Best model saved at epoch 2
Train epoch 2: TotalLoss=0.052, PSNR=13.22
Eval epoch 2: PSNR=14.36
Best model saved at epoch 3
Train epoch 3: TotalLoss=0.05, PSNR=13.297
Eval epoch 3: PSNR=14.445
Best model saved at epoch 4
Train epoch 4: TotalLoss=0.05, PSNR=13.329
Eval epoch 4: PSNR=14.445
...
```none
Eval epoch 0: PSNR=14.445, PSNR no learning=12.59
Test results:
...
**Total running time of the script:** (1 minutes 12.737 seconds)

<a id="sphx-glr-download-auto-examples-unfolded-demo-lista-py"></a>

[`Download Jupyter notebook: demo_LISTA.ipynb`](https://deepinv.org/auto_examples/unfolded/_downloads/1402ab509502465414677b67bf0edb33/demo_LISTA.ipynb)

[`Download Python source code: demo_LISTA.py`](https://deepinv.org/auto_examples/unfolded/_downloads/983ec560bf747210f085f092bd726e54/demo_LISTA.py)

[`Download zipped: demo_LISTA.zip`](https://deepinv.org/auto_examples/unfolded/_downloads/54079a6889d3b619adbbed0cd820c994/demo_LISTA.zip)
