...
```none
Selected GPU 0 with 8893.25 MiB free memory
```
...
{'PSNR no learning': 6.6535491943359375, 'PSNR no learning_std': 0.8941914593348746, 'PSNR': 24.680755615234375, 'PSNR_std': 0.31822799680711245, 'runtime': 0.3217056258581579, 'peak_gpu_memory_usage': 0.42793703079223633}
```
...
**Total running time of the script:** (1 minutes 14.130 seconds)
