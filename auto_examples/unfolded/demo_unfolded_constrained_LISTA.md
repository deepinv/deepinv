...
[`deepinv.datasets.generate_dataset()`](https://deepinv.org/api/stubs/deepinv.datasets.generate_dataset.md#deepinv.datasets.generate_dataset) function.

Once the dataset is generated, we can load it using the [`deepinv.datasets.HDF5Dataset`](https://deepinv.org/api/stubs/deepinv.datasets.HDF5Dataset.md#deepinv.datasets.HDF5Dataset) class.
...
[`deepinv.loss.SupLoss`](https://deepinv.org/api/stubs/deepinv.loss.SupLoss.md#deepinv.loss.SupLoss) class.
...
Train epoch 0: TotalLoss=0.018, PSNR=20.998
Train epoch 1: TotalLoss=0.004, PSNR=26.107
Train epoch 2: TotalLoss=0.003, PSNR=26.34
Train epoch 3: TotalLoss=0.003, PSNR=26.504
Train epoch 4: TotalLoss=0.004, PSNR=26.64
Train epoch 5: TotalLoss=0.003, PSNR=26.754
Train epoch 6: TotalLoss=0.003, PSNR=26.854
Train epoch 7: TotalLoss=0.003, PSNR=26.939
Train epoch 8: TotalLoss=0.003, PSNR=26.997
Train epoch 9: TotalLoss=0.004, PSNR=27.003
```
...
```none
Eval epoch 0: PSNR=24.681, PSNR no learning=6.654
Test results:
PSNR no learning: 6.654 +- 0.894
PSNR: 24.681 +- 0.318

{'PSNR no learning': 6.6535491943359375, 'PSNR no learning_std': 0.8941914593348746, 'PSNR': 24.680755615234375, 'PSNR_std': 0.31822799680711245, 'runtime': 0.32129356684163213, 'peak_gpu_memory_usage': 0.42793703079223633}
```
...
**Total running time of the script:** (1 minutes 14.474 seconds)

<a id="sphx-glr-download-auto-examples-unfolded-demo-unfolded-constrained-lista-py"></a>

[`Download Jupyter notebook: demo_unfolded_constrained_LISTA.ipynb`](https://deepinv.org/auto_examples/unfolded/_downloads/8951ca8fee4e9b4ca466202eee01392f/demo_unfolded_constrained_LISTA.ipynb)

[`Download Python source code: demo_unfolded_constrained_LISTA.py`](https://deepinv.org/auto_examples/unfolded/_downloads/54991abcb2105cbefad71602185c6e3b/demo_unfolded_constrained_LISTA.py)

[`Download zipped: demo_unfolded_constrained_LISTA.zip`](https://deepinv.org/auto_examples/unfolded/_downloads/0f9ad12bd11e94f8fc4c5d9a52b9ed20/demo_unfolded_constrained_LISTA.zip)
