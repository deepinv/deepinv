...
<!-- GENERATED FROM PYTHON SOURCE LINES 60-129 -->
```Python
import torch
...
<!-- GENERATED FROM PYTHON SOURCE LINES 145-319 -->
```Python
...
Running on 1 process(es)
   Device: cuda:0
/local/jtachell/deepinv/deepinv/examples/distributed/demo_pnp_distributed.py:95: DeprecationWarning: Function 'gaussian_blur' is deprecated since 0.4.1. Use 'deepinv.physics.functional.blur.gaussian_blur' instead.
  gaussian_blur(sigma=1.0, device=str(device)),  # Small blur
/local/jtachell/deepinv/deepinv/examples/distributed/demo_pnp_distributed.py:96: DeprecationWarning: Function 'gaussian_blur' is deprecated since 0.4.1. Use 'deepinv.physics.functional.blur.gaussian_blur' instead.
  gaussian_blur(sigma=2.0, device=str(device)),  # Medium blur
/local/jtachell/deepinv/deepinv/examples/distributed/demo_pnp_distributed.py:97: DeprecationWarning: Function 'gaussian_blur' is deprecated since 0.4.1. Use 'deepinv.physics.functional.blur.gaussian_blur' instead.
  gaussian_blur(
...
**Total running time of the script:** (0 minutes 33.082 seconds)
