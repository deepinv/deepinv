...
[`deepinv.distributed.distribute()`](https://deepinv.org/api/stubs/deepinv.distributed.distribute.md#deepinv.distributed.distribute).
...
- $\ell_2$ data fidelity gradient computed using [`deepinv.distributed.framework.DistributedDataFidelity.grad()`](https://deepinv.org/api/stubs/deepinv.distributed.framework.DistributedDataFidelity.md#deepinv.distributed.framework.DistributedDataFidelity.grad)

**Key Steps:**

1. Create stacked physics operators and measurements with reproducible noise
2. Initialize distributed context
3. Distribute physics with [`deepinv.distributed.distribute()`](https://deepinv.org/api/stubs/deepinv.distributed.distribute.md#deepinv.distributed.distribute)
4. Distribute denoiser with tiling configuration
5. Create PnP prior and $\ell_2$ data fidelity
6. Run PnP iterations using [`deepinv.distributed.framework.DistributedDataFidelity.grad()`](https://deepinv.org/api/stubs/deepinv.distributed.framework.DistributedDataFidelity.md#deepinv.distributed.framework.DistributedDataFidelity.grad) for gradient computation
...
Running PnP reconstruction (20 iterations)...
   ...
   Iteration 5/20, PSNR: 30.03 dB
   Iteration 10/20, PSNR: 32.27 dB
   Iteration 15/20, PSNR: 32.59 dB
   Iteration 20/20, PSNR: 32.72 dB

Comparing with non-distributed PnP reconstruction...
   Non-distributed final PSNR: 32.68 dB
   Distributed final PSNR:     32.72 dB
...
[`Download Jupyter notebook: demo_pnp_distributed.ipynb`](https://deepinv.org/auto_examples/distributed/_downloads/f47ded92baab56707908199779fca0c1/demo_pnp_distributed.ipynb)

[`Download Python source code: demo_pnp_distributed.py`](https://deepinv.org/auto_examples/distributed/_downloads/bb5958cd7666649e09b6c583feccf2c2/demo_pnp_distributed.py)

[`Download zipped: demo_pnp_distributed.zip`](https://deepinv.org/auto_examples/distributed/_downloads/ac8347031c2f797563b0bc93af256e79/demo_pnp_distributed.zip)
