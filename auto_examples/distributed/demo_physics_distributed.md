...
This example demonstrates how to use [`deepinv.distributed.distribute()`](https://deepinv.org/api/stubs/deepinv.distributed.distribute.md#deepinv.distributed.distribute) to distribute stacked physics
...
2. Stack them using [`deepinv.physics.stack()`](https://deepinv.org/api/stubs/deepinv.physics.stack.md#deepinv.physics.stack)
3. Initialize distributed context
4. Distribute physics with [`deepinv.distributed.distribute()`](https://deepinv.org/api/stubs/deepinv.distributed.distribute.md#deepinv.distributed.distribute)
...
[`Download Jupyter notebook: demo_physics_distributed.ipynb`](https://deepinv.org/auto_examples/distributed/_downloads/334479ffc64926b8d98e88f7b40f6d45/demo_physics_distributed.ipynb)

[`Download Python source code: demo_physics_distributed.py`](https://deepinv.org/auto_examples/distributed/_downloads/7de68dc6369edbf6689e2654c46c5003/demo_physics_distributed.py)

[`Download zipped: demo_physics_distributed.zip`](https://deepinv.org/auto_examples/distributed/_downloads/9288c72086ed55462150d6d40ea05cc3/demo_physics_distributed.zip)
