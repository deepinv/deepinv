...
This example demonstrates how to use the [`deepinv.distributed.distribute()`](https://deepinv.org/api/stubs/deepinv.distributed.distribute.md#deepinv.distributed.distribute) function to create a
...
5. Distribute denoiser with [`deepinv.distributed.distribute()`](https://deepinv.org/api/stubs/deepinv.distributed.distribute.md#deepinv.distributed.distribute)
...
**Total running time of the script:** (0 minutes 26.812 seconds)

🏷 Tags: Denoising, Distributed

<a id="sphx-glr-download-auto-examples-distributed-demo-denoiser-distributed-py"></a>

[`Download Jupyter notebook: demo_denoiser_distributed.ipynb`](https://deepinv.org/auto_examples/distributed/_downloads/d41d8dc05f0633953a37ec1e33053e57/demo_denoiser_distributed.ipynb)

[`Download Python source code: demo_denoiser_distributed.py`](https://deepinv.org/auto_examples/distributed/_downloads/f32b67ab9fddcc7fb36f675a5e6ac925/demo_denoiser_distributed.py)

[`Download zipped: demo_denoiser_distributed.zip`](https://deepinv.org/auto_examples/distributed/_downloads/3cec0b09facd3a79705983a68ffdcb0e/demo_denoiser_distributed.zip)
