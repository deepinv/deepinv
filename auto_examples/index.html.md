...
<div id='sg-tag-list' class='sphx-glr-tag-list'></div><div class="sphx-glr-thumbnails">
<!-- thumbnail-parent-div-open --><div class="sphx-glr-thumbcontainer" data-sgtags='["Basics", "Denoising", "Foundation model"]' tooltip="Follow this example to get started with DeepInverse in under 5 minutes.">![](auto_examples/basics/images/thumb/sphx_glr_demo_quickstart_thumb.png)
...
</div><div class="sphx-glr-thumbcontainer" data-sgtags='["Diffusion", "Basics", "Denoising", "Plug-and-play", "Foundation model"]' tooltip="Follow this example to reconstruct images using a pretrained model in one line.">![](auto_examples/basics/images/thumb/sphx_glr_demo_pretrained_model_thumb.png)
...
</div><div class="sphx-glr-thumbcontainer" data-sgtags='["Denoising", "Basics"]' tooltip="Follow this example to reconstruct images using an iterative algorithm.">![](auto_examples/basics/images/thumb/sphx_glr_demo_custom_optim_thumb.png)
...
</div><div class="sphx-glr-thumbcontainer" data-sgtags='["Basics"]' tooltip="This example shows how to use DeepInverse with your own dataset.">![](auto_examples/basics/images/thumb/sphx_glr_demo_custom_dataset_thumb.png)
...
</div><div class="sphx-glr-thumbcontainer" data-sgtags='["Basics"]' tooltip="This examples shows you how to use DeepInverse with your own physics.">![](auto_examples/basics/images/thumb/sphx_glr_demo_custom_physics_thumb.png)
...
[Benchmarking pretrained denoisers](https://deepinv.org/auto_examples/models/demo_denoiser_tour.html.md)
...
</div><div class="sphx-glr-thumbcontainer" data-sgtags='["MRI", "Foundation model"]' tooltip="This example reconstructs real prospectively undersampled multicoil brain k-space from yu2022validation.">![](auto_examples/models/images/thumb/sphx_glr_demo_prospective_mri_thumb.png)
...
</div><div class="sphx-glr-thumbcontainer" data-sgtags='["MRI", "Foundation model"]' tooltip="This demo reconstructs undersampled k-space data for 2D cardiac and brain MRI on:">![](auto_examples/models/images/thumb/sphx_glr_demo_mri_pretrained_thumb.png)
...
[Single photon lidar operator for depth ranging.](https://deepinv.org/auto_examples/physics/demo_lidar.html.md)
...
</div><div class="sphx-glr-thumbcontainer" data-sgtags='["Ultrasound"]' tooltip="This example shows how to use deepinv.physics.UltrasoundPlaneWave to reconstructs an in-vivo carotid acquisition of the EPFL LTS5 ultrafast ultrasound dataset from raw RF ultrasound data.">![](auto_examples/plug-and-play/images/thumb/sphx_glr_demo_ultrasound_invivo_PnP_thumb.png)
...
</div><div class="sphx-glr-thumbcontainer" data-sgtags='["Plug-and-play"]' tooltip="Implementation of romano2017little using as plug-in denoiser the Gradient-Step Denoiser (GSPnP) hurault2021gradient which provides an explicit prior.">![](auto_examples/plug-and-play/images/thumb/sphx_glr_demo_RED_GSPnP_SR_thumb.png)
...
</div><div class="sphx-glr-thumbcontainer" data-sgtags='["Tomography"]' tooltip="This example shows how to use a standard PnP algorithm with DnCNN denoiser for computed tomography.">![](auto_examples/plug-and-play/images/thumb/sphx_glr_demo_vanilla_PnP_thumb.png)
...
</div><div class="sphx-glr-thumbcontainer" data-sgtags='["Diffusion"]' tooltip="This demo shows you how to perform unconditional image generation and posterior sampling using Flow Matching (FM).">![](auto_examples/sampling/images/thumb/sphx_glr_demo_flow_matching_thumb.png)
...
</div><div class="sphx-glr-thumbcontainer" data-sgtags='["Deblurring"]' tooltip="This a toy example to show you how to use DEQ to solve a deblurring problem. Note that this is a small dataset for training. For optimal results, use a larger dataset.">![](auto_examples/unfolded/images/thumb/sphx_glr_demo_DEQ_thumb.png)
...
</div><div class="sphx-glr-thumbcontainer" data-sgtags='["Denoising", "Blind problem"]' tooltip="This example focuses on blind image Gaussian denoising, i.e. the problem">![](auto_examples/blind-inverse-problems/images/thumb/sphx_glr_demo_blind_denoising_thumb.png)
...
[Ultrasound despeckling from B-mode images](https://deepinv.org/auto_examples/self-supervised-learning/demo_ultrasound_despeckling.html.md)
...
<div id='sg-tag-list' class='sphx-glr-tag-list'></div><div class="sphx-glr-thumbnails">
<!-- thumbnail-parent-div-open --><div class="sphx-glr-thumbcontainer" tooltip="We demonstrate the use of our deepinv.transform module for use in solving imaging problems. These can be used for:">![](auto_examples/transforms-equivariance/images/thumb/sphx_glr_demo_transforms_thumb.png)
...
</div><div class="sphx-glr-thumbcontainer" data-sgtags='["Tomography"]' tooltip="This example shows how to use the Astra tomography toolbox with deepinv, a popular toolbox for tomography with GPU acceleration.">![](auto_examples/external-libraries/images/thumb/sphx_glr_demo_astra_tomography_thumb.png)
...
</div><div class="sphx-glr-thumbcontainer" data-sgtags='["MRI"]' tooltip="This example reconstructs raw non-Cartesian multicoil kspace data from the FastMRI breast dataset solomonFastMRI2025, for mammography.">![](auto_examples/external-libraries/images/thumb/sphx_glr_demo_mrinufft_breast_thumb.png)
...
</div><div class="sphx-glr-thumbcontainer" data-sgtags='["Single-pixel", "Foundation model"]' tooltip="This example shows how to use Spyrit linear models and measurements with DeepInverse. Here we use the HadamSplit2d linear model from Spyrit.">![](auto_examples/external-libraries/images/thumb/sphx_glr_demo_connect_spyrit_thumb.png)
...
</div><div class="sphx-glr-thumbcontainer" tooltip="This example shows how to load and prepare properly a HuggingFace dataset using the datasets library.">![](auto_examples/external-libraries/images/thumb/sphx_glr_demo_hf_dataset_thumb.png)

[Using HuggingFace datasets](https://deepinv.org/auto_examples/external-libraries/demo_hf_dataset.html.md)

  <div class="sphx-glr-thumbnail-title">Using HuggingFace datasets</div>
</div>
<!-- thumbnail-parent-div-close --></div>
...
[Distributed Denoiser with Image Tiling](https://deepinv.org/auto_examples/distributed/demo_denoiser_distributed.html.md)

  <div class="sphx-glr-thumbnail-title">Distributed Denoiser with Image Tiling</div>
</div><div class="sphx-glr-thumbcontainer" data-sgtags='["Distributed"]' tooltip="Many large-scale imaging problems involve operators that can be naturally decomposed as a stack of multiple sub-operators:">![](auto_examples/distributed/images/thumb/sphx_glr_demo_physics_distributed_thumb.png)
...
</div><div class="sphx-glr-thumbcontainer" data-sgtags='["Distributed", "Plug-and-play"]' tooltip="Many large-scale imaging problems involve operators that can be naturally decomposed as a stack of multiple sub-operators:">![](auto_examples/distributed/images/thumb/sphx_glr_demo_pnp_distributed_thumb.png)
...
</div><div class="sphx-glr-thumbcontainer" data-sgtags='["Denoising", "Metrics"]' tooltip="This example shows how to fit deepinv.loss.metric.NIQE on a new dataset, and use it to evaluate denoiser performance.">![](auto_examples/metrics/images/thumb/sphx_glr_demo_custom_niqe_thumb.png)
...
[`Download all examples in Python source code: auto_examples_python.zip`](https://deepinv.org/auto_examples/_downloads/07fcc19ba03226cd3d83d4e40ec44385/auto_examples_python.zip)

[`Download all examples in Jupyter notebooks: auto_examples_jupyter.zip`](https://deepinv.org/auto_examples/_downloads/6f1e7a639e0699d6164445b55e6c116d/auto_examples_jupyter.zip)
