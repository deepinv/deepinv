...
```none
Naive noise level estimate:  0.15920020639896393
```
...
This is implemented in [`deepinv.models.WaveletNoiseEstimator`](https://deepinv.org/api/stubs/deepinv.models.WaveletNoiseEstimator.md#deepinv.models.WaveletNoiseEstimator). Under the hood, the estimator uses the
...
```none
Wavelet-based noise level estimate:  0.05346919596195221
```
...
image. This is implemented in [`deepinv.models.PatchCovarianceNoiseEstimator`](https://deepinv.org/api/stubs/deepinv.models.PatchCovarianceNoiseEstimator.md#deepinv.models.PatchCovarianceNoiseEstimator).
...
```none
Patch covariance-based noise level estimate:  0.04184475913643837
```
...
<!-- GENERATED FROM PYTHON SOURCE LINES 146-204 -->
```Python
...
[`Download Jupyter notebook: demo_blind_denoising.ipynb`](https://deepinv.org/auto_examples/blind-inverse-problems/_downloads/d09b113330e9c51297ed8773823e5250/demo_blind_denoising.ipynb)

[`Download Python source code: demo_blind_denoising.py`](https://deepinv.org/auto_examples/blind-inverse-problems/_downloads/21ab810c352def39941639675c176100/demo_blind_denoising.py)

[`Download zipped: demo_blind_denoising.zip`](https://deepinv.org/auto_examples/blind-inverse-problems/_downloads/b8a47166c014959438c73f42b5cae2f8/demo_blind_denoising.zip)
