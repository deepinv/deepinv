...
You can access the whole dataset using [`deepinv.datasets.Kohler`](https://deepinv.org/api/stubs/deepinv.datasets.Kohler.md#deepinv.datasets.Kohler).
...
Here we use the general reconstruction model [`deepinv.models.RAM`](https://deepinv.org/api/stubs/deepinv.models.RAM.md#deepinv.models.RAM) and the plug-and-play method [`deepinv.optim.DPIR`](https://deepinv.org/api/stubs/deepinv.optim.DPIR.md#deepinv.optim.DPIR).
...
**Total running time of the script:** (3 minutes 41.391 seconds)
...
[`Download Jupyter notebook: demo_blind_deblurring.ipynb`](https://deepinv.org/auto_examples/blind-inverse-problems/_downloads/9231023c22af192ad3f014b905878cc6/demo_blind_deblurring.ipynb)

[`Download Python source code: demo_blind_deblurring.py`](https://deepinv.org/auto_examples/blind-inverse-problems/_downloads/81086324e077a9f0f0d515cb7d929287/demo_blind_deblurring.py)

[`Download zipped: demo_blind_deblurring.zip`](https://deepinv.org/auto_examples/blind-inverse-problems/_downloads/047d964d61f6f2b365ff6d0faa809fc6/demo_blind_deblurring.zip)
