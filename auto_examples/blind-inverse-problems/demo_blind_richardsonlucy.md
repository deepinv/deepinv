...
[`deepinv.optim.MLEM`](https://deepinv.org/api/stubs/deepinv.optim.MLEM.md#deepinv.optim.MLEM) used on measurements involving a blur physics.
...
normalized to unit sum. The [`deepinv.optim.BlindRL`](https://deepinv.org/api/stubs/deepinv.optim.BlindRL.md#deepinv.optim.BlindRL) class implements
these alternating updates.

This algorithm is implemented under the [`deepinv.optim.BlindRL`](https://deepinv.org/api/stubs/deepinv.optim.BlindRL.md#deepinv.optim.BlindRL) class.
...
This enables the use of any prior implementing the [`deepinv.optim.prior.Prior`](https://deepinv.org/api/stubs/deepinv.optim.Prior.md#deepinv.optim.Prior)
interface inside the [`deepinv.optim.BlindRL`](https://deepinv.org/api/stubs/deepinv.optim.BlindRL.md#deepinv.optim.BlindRL) class.
...
The image and kernel regularizers can be specified independently using the `x_prior` and `k_prior` arguments of the [`deepinv.optim.BlindRL`](https://deepinv.org/api/stubs/deepinv.optim.BlindRL.md#deepinv.optim.BlindRL) class.
Below, we use TV regularization on the image through the [`deepinv.optim.TVPrior`](https://deepinv.org/api/stubs/deepinv.optim.TVPrior.md#deepinv.optim.TVPrior) class and no regularization on the kernel.
