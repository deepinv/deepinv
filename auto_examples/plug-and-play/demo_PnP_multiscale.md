...
For both models, we use a [`L2`](https://deepinv.org/api/stubs/deepinv.optim.L2.md#deepinv.optim.L2) data
fidelity term and a pre-trained [`DRUNet`](https://deepinv.org/api/stubs/deepinv.models.DRUNet.md#deepinv.models.DRUNet)
denoiser.
...
Test:   0%|          | 0/1 [00:02<?, ?it/s, PSNR=7.69, PSNR no learning=7.44]
Test: 100%|██████████| 1/1 [00:03<00:00,  3.28s/it, PSNR=7.69, PSNR no learning=7.44]
Test: 100%|██████████| 1/1 [00:03<00:00,  3.28s/it, PSNR=7.69, PSNR no learning=7.44]
Test results:
...
PSNR: 7.695 +- 1.491
  ...
  0%|          | 0/1 [00:00<?, ?it/s]
Test:   0%|          | 0/1 [00:00<?, ?it/s]
Test:   0%|          | 0/1 [00:01<?, ?it/s, PSNR=19.7, PSNR no learning=7.44]
Test: 100%|██████████| 1/1 [00:02<00:00,  2.09s/it, PSNR=19.7, PSNR no learning=7.44]
Test: 100%|██████████| 1/1 [00:02<00:00,  2.09s/it, PSNR=19.7, PSNR no learning=7.44]
Test results:
PSNR no learning: 7.444 +- 1.436
PSNR: 19.733 +- 1.593

{'PSNR no learning': 7.444142659505208, 'PSNR no learning_std': 1.4358848891431464, 'PSNR': 19.73254140218099, 'PSNR_std': 1.5933858591405172, 'runtime': 2.095403695013374, 'peak_gpu_memory_usage': 0.8402266502380371}
```
...
[`Download Jupyter notebook: demo_PnP_multiscale.ipynb`](https://deepinv.org/auto_examples/plug-and-play/_downloads/f4ed4ab524c2449cd28f7d37e38d4775/demo_PnP_multiscale.ipynb)

[`Download Python source code: demo_PnP_multiscale.py`](https://deepinv.org/auto_examples/plug-and-play/_downloads/99dde8bb74607d099ea880557947a4e9/demo_PnP_multiscale.py)

[`Download zipped: demo_PnP_multiscale.zip`](https://deepinv.org/auto_examples/plug-and-play/_downloads/d603188b9f998f20823d5e6ec6560549/demo_PnP_multiscale.zip)
