...
This example shows how to use [`deepinv.physics.UltrasoundPlaneWave`](https://deepinv.org/api/stubs/deepinv.physics.UltrasoundPlaneWave.md#deepinv.physics.UltrasoundPlaneWave) to reconstructs an in-vivo carotid acquisition of the
...
3. **Least squares with 1 plane-wave** with [`A_dagger`](https://deepinv.org/api/stubs/deepinv.physics.LinearPhysics.md#deepinv.physics.LinearPhysics.A_dagger) using conjugate gradient.
4. **Plug-and-Play with 1 plane-wave** with [`proximal gradient descent`](https://deepinv.org/api/stubs/deepinv.optim.PGD.md#deepinv.optim.PGD) with a [`PnP`](https://deepinv.org/api/stubs/deepinv.optim.PnP.md#deepinv.optim.PnP) prior using wavelet and BM3D denoisers.
...
[`UltrasoundPlaneWave`](https://deepinv.org/api/stubs/deepinv.physics.UltrasoundPlaneWave.md#deepinv.physics.UltrasoundPlaneWave).
...
#### NOTE
See [`deepinv.physics.UltrasoundPlaneWave`](https://deepinv.org/api/stubs/deepinv.physics.UltrasoundPlaneWave.md#deepinv.physics.UltrasoundPlaneWave) for how to set other parameters such as f-number or apodization.
...
First, we instantiate [`deepinv.physics.UltrasoundPlaneWave`](https://deepinv.org/api/stubs/deepinv.physics.UltrasoundPlaneWave.md#deepinv.physics.UltrasoundPlaneWave) with all 87 angles and use this for beamforming
...
We compute the CPWC adjoint and plot the B-mode image with an amplitude floor of -50dB with [`deepinv.utils.bmode()`](https://deepinv.org/api/stubs/deepinv.utils.bmode.md#deepinv.utils.bmode).
...
This leads to the well-known plug and play reconstruction which relies on the proximal gradient descent algorithm (see [`deepinv.optim.PGD`](https://deepinv.org/api/stubs/deepinv.optim.PGD.md#deepinv.optim.PGD))
along with the plug-and-play prior (see [`deepinv.optim.PnP`](https://deepinv.org/api/stubs/deepinv.optim.PnP.md#deepinv.optim.PnP))
...
[`deepinv.optim.WaveletPrior`](https://deepinv.org/api/stubs/deepinv.optim.WaveletPrior.md#deepinv.optim.WaveletPrior) amounts to iterative soft-thresholding.
...
As a second prior, we rely on a plug-and-play approximation ([`deepinv.optim.PnP`](https://deepinv.org/api/stubs/deepinv.optim.PnP.md#deepinv.optim.PnP)) i.e. the image lies in the
fixed point set of the generic BM3D denoiser ([`deepinv.models.BM3D`](https://deepinv.org/api/stubs/deepinv.models.BM3D.md#deepinv.models.BM3D)).
