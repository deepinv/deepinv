...
<!-- GENERATED FROM PYTHON SOURCE LINES 75-120 -->
```Python
...
{'PSNR no learning': 7.444142659505208, 'PSNR no learning_std': 1.4358848891431464, 'PSNR': 19.73254140218099, 'PSNR_std': 1.5933858591405172, 'runtime': 2.0916974369902164, 'peak_gpu_memory_usage': 0.8402266502380371}
```
