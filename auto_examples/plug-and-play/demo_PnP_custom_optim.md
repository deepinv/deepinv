...
The iterator should be a subclass of [`deepinv.optim.OptimIterator`](https://deepinv.org/api/stubs/deepinv.optim.OptimIterator.md#deepinv.optim.OptimIterator).
...
The iterator relies on custom fStepCV (subclass of [`deepinv.optim.optim_iterators.fStep`](https://deepinv.org/api/stubs/deepinv.optim.optim_iterators.fStep.md#deepinv.optim.optim_iterators.fStep))
and gStepCV (subclass of [`deepinv.optim.optim_iterators.gStep`](https://deepinv.org/api/stubs/deepinv.optim.optim_iterators.gStep.md#deepinv.optim.optim_iterators.gStep)) modules.
...
Define the Conva-Vu model as a subclass of [`deepinv.optim.BaseOptim`](https://deepinv.org/api/stubs/deepinv.optim.BaseOptim.md#deepinv.optim.BaseOptim),
in the model of other optimizer of the library, see for example [`deepinv.optim.ADMM`](https://deepinv.org/api/stubs/deepinv.optim.ADMM.md#deepinv.optim.ADMM).
—————————————————————————————-
...
We use the [`deepinv.physics.SinglePixelCamera`](https://deepinv.org/api/stubs/deepinv.physics.SinglePixelCamera.md#deepinv.physics.SinglePixelCamera)
...
We build the PnP model using our custom [`deepinv.optim.PDCP()`](https://deepinv.org/api/stubs/deepinv.optim.PDCP.md#deepinv.optim.PDCP) function.

The primal dual stepsizes $\tau$ corresponds to the `stepsize` key and $\sigma$ to the `sigma` key.

For the denoiser, we choose the 1-Lipschitz grayscale DnCNN model (see the [pretrained-weights](https://deepinv.org/user_guide/reconstruction/pretrained-models.md#pretrained-weights)).
...
[`Download Jupyter notebook: demo_PnP_custom_optim.ipynb`](https://deepinv.org/auto_examples/plug-and-play/_downloads/b33a1eb4de39658ecbc7b0bf022ff0b2/demo_PnP_custom_optim.ipynb)

[`Download Python source code: demo_PnP_custom_optim.py`](https://deepinv.org/auto_examples/plug-and-play/_downloads/824bbc71c8aa5f4974a95a73388afbe3/demo_PnP_custom_optim.py)

[`Download zipped: demo_PnP_custom_optim.zip`](https://deepinv.org/auto_examples/plug-and-play/_downloads/59cd8864b56efe5b6b42f7bb988ab466/demo_PnP_custom_optim.zip)
