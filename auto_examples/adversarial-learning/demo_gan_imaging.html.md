...
/local/jtachell/deepinv/deepinv/deepinv/training/adversarial.py:168: UserWarning: optimizer_step_multi_dataset parameter of Trainer is should be set to `False` when using adversarial trainer. Automatically setting it to `False`.
  warnings.warn(
Train epoch 0: SupLoss=0.005, SupAdversarialGeneratorLoss=0.003, TotalLoss=0.008, PSNR=24.851
Eval epoch 0: PSNR=26.279
...
```none
Eval epoch 0: PSNR=26.279, PSNR no learning=25.728
Test results:
PSNR no learning: 25.728 +- 4.193
PSNR: 26.279 +- 2.767

{'PSNR no learning': 25.728416919708252, 'PSNR no learning_std': 4.193494667036911, 'PSNR': 26.279018497467042, 'PSNR_std': 2.767217967827013, 'runtime': 0.30788203701376915, 'peak_gpu_memory_usage': 0.49907398223876953}
```
...
```none
The model has 444867 trainable parameters
Train epoch 0: TotalLoss=0.139, PSNR=24.131
Eval epoch 0: PSNR=25.674
Best model saved at epoch 1
```
...
```none
Eval epoch 0: PSNR=25.674, PSNR no learning=25.728
Test results:
PSNR no learning: 25.728 +- 4.193
PSNR: 25.674 +- 2.579

{'PSNR no learning': 25.728416919708252, 'PSNR no learning_std': 4.193494667036911, 'PSNR': 25.674273586273195, 'PSNR_std': 2.578533367147936, 'runtime': 0.4904776709154248, 'peak_gpu_memory_usage': 0.4985923767089844}
```
...
Train epoch 0: TotalLoss=0.008, PSNR=9.082
```
...
```none
Eval epoch 0: PSNR=9.887, PSNR no learning=25.728
Test results:
PSNR no learning: 25.728 +- 4.193
PSNR: 9.887 +- 1.004

{'PSNR no learning': 25.728416919708252, 'PSNR no learning_std': 4.193494667036911, 'PSNR': 9.886523461341858, 'PSNR_std': 1.0038250560293862, 'runtime': 3.894623746164143, 'peak_gpu_memory_usage': 0.5217399597167969}
```
...
**Total running time of the script:** (0 minutes 26.100 seconds)

🏷 Tags: Deblurring, GANs

<a id="sphx-glr-download-auto-examples-adversarial-learning-demo-gan-imaging-py"></a>

[`Download Jupyter notebook: demo_gan_imaging.ipynb`](https://deepinv.org/auto_examples/adversarial-learning/_downloads/2f3e20ed263cc3e5c7e770603c2bda28/demo_gan_imaging.ipynb)

[`Download Python source code: demo_gan_imaging.py`](https://deepinv.org/auto_examples/adversarial-learning/_downloads/1b08a6c94b052657775204a9369c2c98/demo_gan_imaging.py)

[`Download zipped: demo_gan_imaging.zip`](https://deepinv.org/auto_examples/adversarial-learning/_downloads/74982483541b96cb559b9926a0156344/demo_gan_imaging.zip)
