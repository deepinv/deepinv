...
[here](https://deepinv.org/user_guide/physics/physics.md#physics).
...
The denoising class [`deepinv.physics.Denoising`](https://deepinv.org/api/stubs/deepinv.physics.Denoising.md#deepinv.physics.Denoising) is associated with an identity operator.
...
The inpainting class [`deepinv.physics.Inpainting`](https://deepinv.org/api/stubs/deepinv.physics.Inpainting.md#deepinv.physics.Inpainting) is associated with a mask operator.
...
The demosaicing class [`deepinv.physics.Demosaicing`](https://deepinv.org/api/stubs/deepinv.physics.Demosaicing.md#deepinv.physics.Demosaicing) is associated with a Bayer pattern,
...
The compressed sensing class [`deepinv.physics.CompressedSensing`](https://deepinv.org/api/stubs/deepinv.physics.CompressedSensing.md#deepinv.physics.CompressedSensing) is associated with a random Gaussian matrix.
...
The class [`deepinv.physics.Tomography`](https://deepinv.org/api/stubs/deepinv.physics.Tomography.md#deepinv.physics.Tomography) is associated with the sparse Radon transform.
Here we take 40 views of an image of size 64x64, and consider mixed Poisson-Gaussian noise.

#### NOTE
The filtered backprojection (FBP) can be computed using the method [`deepinv.physics.Tomography.fbp()`](https://deepinv.org/api/stubs/deepinv.physics.Tomography.md#deepinv.physics.Tomography.fbp) of the physics object.
This does not coincide with the linear pseudo-inverse, computed with [`deepinv.physics.Tomography.A_dagger()`](https://deepinv.org/api/stubs/deepinv.physics.Tomography.md#deepinv.physics.Tomography.A_dagger)
...
The class [`deepinv.physics.MRI`](https://deepinv.org/api/stubs/deepinv.physics.MRI.md#deepinv.physics.MRI) is associated with a subsampling of the Fourier transform.
...
The class [`deepinv.physics.Decolorize`](https://deepinv.org/api/stubs/deepinv.physics.Decolorize.md#deepinv.physics.Decolorize) is associated with a simple
...
The class [`deepinv.physics.Pansharpen`](https://deepinv.org/api/stubs/deepinv.physics.Pansharpen.md#deepinv.physics.Pansharpen) obtains measurements which consist of
...
The single-pixel camera class [`deepinv.physics.SinglePixelCamera`](https://deepinv.org/api/stubs/deepinv.physics.SinglePixelCamera.md#deepinv.physics.SinglePixelCamera) is associated with `m` binary patterns.
...
The class [`deepinv.physics.Blur`](https://deepinv.org/api/stubs/deepinv.physics.Blur.md#deepinv.physics.Blur) blurs the input image with a specified kernel.
...
The downsampling class [`deepinv.physics.Downsampling`](https://deepinv.org/api/stubs/deepinv.physics.Downsampling.md#deepinv.physics.Downsampling) is associated with a downsampling operator.
