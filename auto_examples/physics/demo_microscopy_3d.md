...
```none
Selected GPU 0 with 6909.25 MiB free memory
```
...
The class [`deepinv.physics.Blur`](https://deepinv.org/api/stubs/deepinv.physics.Blur.md#deepinv.physics.Blur) implements convolution operations with kernels. It will
...
```none
/local/jtachell/deepinv/deepinv/deepinv/utils/plotting.py:1309: UserWarning: This figure was using a layout engine that is incompatible with subplots_adjust and/or tight_layout; not calling subplots_adjust.
...
the class [`deepinv.physics.generator.PSFGenerator`](https://deepinv.org/api/stubs/deepinv.physics.generator.PSFGenerator.md#deepinv.physics.generator.PSFGenerator), that we used to construct
...
[`deepinv.physics.generator.DiffractionBlurGenerator3D`](https://deepinv.org/api/stubs/deepinv.physics.generator.DiffractionBlurGenerator3D.md#deepinv.physics.generator.DiffractionBlurGenerator3D).
...
We implemented the PSF of a confocal microscope in [`deepinv.physics.generator.ConfocalBlurGenerator3D`](https://deepinv.org/api/stubs/deepinv.physics.generator.ConfocalBlurGenerator3D.md#deepinv.physics.generator.ConfocalBlurGenerator3D).
...
[`Download Jupyter notebook: demo_microscopy_3d.ipynb`](https://deepinv.org/auto_examples/physics/_downloads/0761c230c95adff9d8403f96e22c8019/demo_microscopy_3d.ipynb)

[`Download Python source code: demo_microscopy_3d.py`](https://deepinv.org/auto_examples/physics/_downloads/c77c615cee26ed04f946f573e122dfba/demo_microscopy_3d.py)

[`Download zipped: demo_microscopy_3d.zip`](https://deepinv.org/auto_examples/physics/_downloads/1be6a9b8c5e63825e69191ac202ae4ec/demo_microscopy_3d.zip)
