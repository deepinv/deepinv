...
- Physics: [`deepinv.physics.MRI`](https://deepinv.org/api/stubs/deepinv.physics.MRI.md#deepinv.physics.MRI),
  [`deepinv.physics.MultiCoilMRI`](https://deepinv.org/api/stubs/deepinv.physics.MultiCoilMRI.md#deepinv.physics.MultiCoilMRI),
  [`deepinv.physics.DynamicMRI`](https://deepinv.org/api/stubs/deepinv.physics.DynamicMRI.md#deepinv.physics.DynamicMRI)
- Datasets: raw kspace with the [FastMRI](https://fastmri.med.nyu.edu) dataset
  [`deepinv.datasets.FastMRISliceDataset`](https://deepinv.org/api/stubs/deepinv.datasets.FastMRISliceDataset.md#deepinv.datasets.FastMRISliceDataset) and an in-memory easy-to-use version
  [`deepinv.datasets.SimpleFastMRISliceDataset`](https://deepinv.org/api/stubs/deepinv.datasets.SimpleFastMRISliceDataset.md#deepinv.datasets.SimpleFastMRISliceDataset), and raw dynamic k-t-space data with the
  [CMRxRecon](https://cmrxrecon.github.io) dataset.
- Models: [`deepinv.models.VarNet`](https://deepinv.org/api/stubs/deepinv.models.VarNet.md#deepinv.models.VarNet)
  (VarNet Hammernik *et al.*<sup>[1](#footcite-hammernik2018learning)</sup>, E2E-VarNet Sriram *et al.*<sup>[2](#footcite-sriram2020end)</sup>),
  [`deepinv.models.MoDL`](https://deepinv.org/api/stubs/deepinv.models.MoDL.md#deepinv.models.MoDL) (a simple MoDL Aggarwal *et al.*<sup>[3](#footcite-aggarwal2018modl)</sup> unrolled model)
...
[`deepinv.physics.MultiCoilMRI`](https://deepinv.org/api/stubs/deepinv.physics.MultiCoilMRI.md#deepinv.physics.MultiCoilMRI) (note that since we are not
...
[`deepinv.physics.MRI`](https://deepinv.org/api/stubs/deepinv.physics.MRI.md#deepinv.physics.MRI) or
[`deepinv.physics.MultiCoilMRI`](https://deepinv.org/api/stubs/deepinv.physics.MultiCoilMRI.md#deepinv.physics.MultiCoilMRI).
...
sequences and load them using [`deepinv.datasets.CMRxReconSliceDataset`](https://deepinv.org/api/stubs/deepinv.datasets.CMRxReconSliceDataset.md#deepinv.datasets.CMRxReconSliceDataset)
...
[`deepinv.Trainer`](https://deepinv.org/api/stubs/deepinv.Trainer.md#deepinv.Trainer), which will automatically load in the data
...
We provide a video plotting function, [`deepinv.utils.plot_videos`](https://deepinv.org/api/stubs/deepinv.utils.plot_videos.md#deepinv.utils.plot_videos). Here, we
