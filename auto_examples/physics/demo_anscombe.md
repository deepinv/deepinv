...
[`Poisson-Gaussian noise`](https://deepinv.org/api/stubs/deepinv.physics.PoissonGaussianNoise.md#deepinv.physics.PoissonGaussianNoise) using the
[`Generalized Anscombe Transform (GAT)`](https://deepinv.org/api/stubs/deepinv.models.AnscombeDenoiser.md#deepinv.models.AnscombeDenoiser), which
...
* **DRUNet baseline** – the pretrained [`DRUNet`](https://deepinv.org/api/stubs/deepinv.models.DRUNet.md#deepinv.models.DRUNet) Gaussian
  denoiser applied directly to the noisy measurement, using a global noise-level heuristic.
* **DRUNet with spatial noise maps** – the pretrained [`DRUNet`](https://deepinv.org/api/stubs/deepinv.models.DRUNet.md#deepinv.models.DRUNet)
...
* **Anscombe + DRUNet** – the same DRUNet wrapped with
  [`AnscombeDenoiser`](https://deepinv.org/api/stubs/deepinv.models.AnscombeDenoiser.md#deepinv.models.AnscombeDenoiser), which first
...
The full pipeline of [`AnscombeDenoiser`](https://deepinv.org/api/stubs/deepinv.models.AnscombeDenoiser.md#deepinv.models.AnscombeDenoiser)
reads:
...
([`PatchCovarianceNoiseEstimator`](https://deepinv.org/api/stubs/deepinv.models.PatchCovarianceNoiseEstimator.md#deepinv.models.PatchCovarianceNoiseEstimator))
...
[`DRUNet`](https://deepinv.org/api/stubs/deepinv.models.DRUNet.md#deepinv.models.DRUNet) is a powerful Gaussian denoiser.
We wrap it with [`AnscombeDenoiser`](https://deepinv.org/api/stubs/deepinv.models.AnscombeDenoiser.md#deepinv.models.AnscombeDenoiser)
...
* [`AnscombeDenoiser`](https://deepinv.org/api/stubs/deepinv.models.AnscombeDenoiser.md#deepinv.models.AnscombeDenoiser) is a
