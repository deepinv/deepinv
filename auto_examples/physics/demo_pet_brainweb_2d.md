...
The slice contains five hot lesions, we simulate a sinogram with [`deepinv.physics.PET`](https://deepinv.org/api/stubs/deepinv.physics.PET.md#deepinv.physics.PET)
...
and BSREM additionally uses the Relative Difference Prior (RDP) [`deepinv.optim.RDP`](https://deepinv.org/api/stubs/deepinv.optim.RDP.md#deepinv.optim.RDP) as $\regname$ in $f(x)+\lambda\reg{x}$.
...
We begin by loading a volume through [`deepinv.datasets.BrainWebPET`](https://deepinv.org/api/stubs/deepinv.datasets.BrainWebPET.md#deepinv.datasets.BrainWebPET),
...
[`deepinv.datasets.BrainWebPET`](https://deepinv.org/api/stubs/deepinv.datasets.BrainWebPET.md#deepinv.datasets.BrainWebPET) can add synthetic lesions with
