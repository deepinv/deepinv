...
See also the [normalized 2D PET example](https://deepinv.org/auto_examples/physics/demo_pet2d.md#sphx-glr-auto-examples-physics-demo-pet2d-py).
...
#### TIP
If you prefer to get started with PET on a simpler 2D problem, please check out [the 2D PET demo](https://deepinv.org/auto_examples/physics/demo_pet2d.md#sphx-glr-auto-examples-physics-demo-pet2d-py).
...
and can be updated via [`physics.update(...)`](https://deepinv.org/api/stubs/deepinv.physics.Physics.md#deepinv.physics.Physics.update) or by passing them as kwargs in
[`physics(x, ...)`](https://deepinv.org/api/stubs/deepinv.physics.Physics.md#deepinv.physics.Physics.forward), [`physics.A(x, ...)`](https://deepinv.org/api/stubs/deepinv.physics.Physics.md#deepinv.physics.Physics.A) or
[`physics.A_adjoint(y, ...)`](https://deepinv.org/api/stubs/deepinv.physics.LinearPhysics.md#deepinv.physics.LinearPhysics.A_adjoint).
...
[`A_dagger`](https://deepinv.org/api/stubs/deepinv.physics.LinearPhysics.md#deepinv.physics.LinearPhysics.A_dagger).
...
/local/jtachell/deepinv/deepinv/deepinv/physics/forward.py:639: DeprecationWarning: Using `compute_norm(squared=True)` is deprecated. Use `compute_sqnorm()` instead to compute the squared spectral norm (||A^T A||_2). In a future version, `compute_norm()` will compute the non-squared spectral norm (||A||_2) by default.
  warnings.warn(
Power iteration converged at iteration 10, ||A^T A||_2=0.99
Norm operator: 0.99
```
...
pre-split inputs can be created with [`deepinv.physics.split_measurements()`](https://deepinv.org/api/stubs/deepinv.physics.split_measurements.md#deepinv.physics.split_measurements) and
[`deepinv.physics.split_physics()`](https://deepinv.org/api/stubs/deepinv.physics.split_physics.md#deepinv.physics.split_physics) and passed directly to [`deepinv.optim.OSEM`](https://deepinv.org/api/stubs/deepinv.optim.OSEM.md#deepinv.optim.OSEM).
...
- Reconstructing PET with learning-based methods ([PnP](https://deepinv.org/user_guide/reconstruction/iterative.md#iterative), [diffusion](https://deepinv.org/user_guide/reconstruction/sampling.md#sampling), [unrolled](https://deepinv.org/user_guide/reconstruction/unfolded.md#unfolded), etc.)
...
**Total running time of the script:** (0 minutes 15.905 seconds)

🏷 Tags: Tomography, PET/SPECT

<a id="sphx-glr-download-auto-examples-physics-demo-pet3d-py"></a>

[`Download Jupyter notebook: demo_pet3d.ipynb`](https://deepinv.org/auto_examples/physics/_downloads/2775468dc95494f8de216087fccc1343/demo_pet3d.ipynb)

[`Download Python source code: demo_pet3d.py`](https://deepinv.org/auto_examples/physics/_downloads/6e7db66cf381ecc0de5f82bdee647998/demo_pet3d.py)

[`Download zipped: demo_pet3d.zip`](https://deepinv.org/auto_examples/physics/_downloads/9b4465fb87591e11f2ba6914b75fc93b/demo_pet3d.zip)
