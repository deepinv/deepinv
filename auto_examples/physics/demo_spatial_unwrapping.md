...
This demo shows the use of the [`deepinv.physics.SpatialUnwrapping`](https://deepinv.org/api/stubs/deepinv.physics.SpatialUnwrapping.md#deepinv.physics.SpatialUnwrapping) forward model and the [`deepinv.optim.ItohFidelity`](https://deepinv.org/api/stubs/deepinv.optim.ItohFidelity.md#deepinv.optim.ItohFidelity) for unwrapping problems, which occur in modulo imaging, interferometry SAR and other imaging applications.
...
[`Download Jupyter notebook: demo_spatial_unwrapping.ipynb`](https://deepinv.org/auto_examples/physics/_downloads/24478d0b60665b5b11d7021348213afc/demo_spatial_unwrapping.ipynb)

[`Download Python source code: demo_spatial_unwrapping.py`](https://deepinv.org/auto_examples/physics/_downloads/c8a452f24fff78c99c64e0092d428211/demo_spatial_unwrapping.py)

[`Download zipped: demo_spatial_unwrapping.zip`](https://deepinv.org/auto_examples/physics/_downloads/45e4447f01e0920b003a280fba0f6605/demo_spatial_unwrapping.zip)
