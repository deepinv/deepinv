...
First, we use the function [`deepinv.optim.L2`](https://deepinv.org/api/stubs/deepinv.optim.L2.md#deepinv.optim.L2) as the data fidelity function, and the class [`deepinv.optim.optim_iterators.GDIteration`](https://deepinv.org/api/stubs/deepinv.optim.optim_iterators.GDIteration.md#deepinv.optim.optim_iterators.GDIteration) as the optimizer to run a gradient descent algorithm. The initial guess is a random complex signal.
...
Therefore, we use the function [`deepinv.optim.phase_retrieval.correct_global_phase`](https://deepinv.org/api/stubs/deepinv.optim.phase_retrieval.correct_global_phase.md#deepinv.optim.phase_retrieval.correct_global_phase) to correct the global phase shift of the estimated signal x_est to make it closer to the original signal x_phase.
...
Spectral methods [`deepinv.optim.phase_retrieval.spectral_methods`](https://deepinv.org/api/stubs/deepinv.optim.phase_retrieval.spectral_methods.md#deepinv.optim.phase_retrieval.spectral_methods) offers a good initial guess on the original signal. Moreover, [`deepinv.physics.RandomPhaseRetrieval`](https://deepinv.org/api/stubs/deepinv.physics.RandomPhaseRetrieval.md#deepinv.physics.RandomPhaseRetrieval) uses spectral methods as its default reconstruction method `A_dagger`, which we can directly call.
...
**Total running time of the script:** (0 minutes 10.381 seconds)

🏷 Tags: Plug-and-play

<a id="sphx-glr-download-auto-examples-physics-demo-phase-retrieval-py"></a>

[`Download Jupyter notebook: demo_phase_retrieval.ipynb`](https://deepinv.org/auto_examples/physics/_downloads/9b34c9b1030da0c6d31466da3ee5468e/demo_phase_retrieval.ipynb)

[`Download Python source code: demo_phase_retrieval.py`](https://deepinv.org/auto_examples/physics/_downloads/3c1262aabc378cc6e73e66ac5dd7198a/demo_phase_retrieval.py)

[`Download zipped: demo_phase_retrieval.zip`](https://deepinv.org/auto_examples/physics/_downloads/8c255ccdb352ac054e8783903b21f615/demo_phase_retrieval.zip)
