...
carefully handle the normalization. See also the [unnormalized 3D PET example](https://deepinv.org/auto_examples/physics/demo_pet3d.md#sphx-glr-auto-examples-physics-demo-pet3d-py).
...
```none
MLEM runtime: 0.48 s for 40 iterations
...
Alternatively, pre-split inputs can be created with  [`deepinv.physics.split_measurements()`](https://deepinv.org/api/stubs/deepinv.physics.split_measurements.md#deepinv.physics.split_measurements)
and [`deepinv.physics.split_physics()`](https://deepinv.org/api/stubs/deepinv.physics.split_physics.md#deepinv.physics.split_physics) and passed directly to [`deepinv.optim.OSEM`](https://deepinv.org/api/stubs/deepinv.optim.OSEM.md#deepinv.optim.OSEM).
...
```none
OSEM runtime: 1.25 s for 5 iterations (8 subsets)
Reconstruction speedup MLEM/OSEM: 0.38x
/local/jtachell/deepinv/deepinv/deepinv/utils/plotting.py:510: UserWarning: set_ticklabels() should only be used with a fixed number of ticks, i.e. after set_ticks() or using a FixedLocator. Otherwise, ticks may be mislabeled.
  colbar.set_ticklabels(true_labels)
/local/jtachell/deepinv/deepinv/deepinv/utils/plotting.py:510: UserWarning: set_ticklabels() should only be used with a fixed number of ticks, i.e. after set_ticks() or using a FixedLocator. Otherwise, ticks may be mislabeled.
  colbar.set_ticklabels(true_labels)
...
- Check out the [3D PET example](https://deepinv.org/auto_examples/physics/demo_pet3d.md#sphx-glr-auto-examples-physics-demo-pet3d-py).
...
[`Download Jupyter notebook: demo_pet2d.ipynb`](https://deepinv.org/auto_examples/physics/_downloads/b4de993a320ab53872b58c43849115f0/demo_pet2d.ipynb)

[`Download Python source code: demo_pet2d.py`](https://deepinv.org/auto_examples/physics/_downloads/abea3bad48917df8cf647665e4c0fdda/demo_pet2d.py)

[`Download zipped: demo_pet2d.zip`](https://deepinv.org/auto_examples/physics/_downloads/36e43b479ca688aec247ae748b26bcbb/demo_pet2d.zip)
