...
For each of the $i=1,\dots,T$ transmitters, the 2D forward model is given by the inhomogeneous Helmholtz equation (see e.g., Soubies *et al.* [[148](https://deepinv.org/user_guide/other/biblio.html.md#id19)]):
...
gradient evaluation (see e.g. Soubies *et al.* [[148](https://deepinv.org/user_guide/other/biblio.html.md#id19)]), and does not require storing all intermediate variables (as in standard backpropagation via PyTorch autograd).
...
**Total running time of the script:** (1 minutes 34.382 seconds)
