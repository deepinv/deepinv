...
In this example we show how to use the [`deepinv.physics.Scattering`](https://deepinv.org/api/stubs/deepinv.physics.Scattering.md#deepinv.physics.Scattering) forward model.
...
For each of the $i=1,\dots,T$ transmitters, the 2D forward model is given by the inhomogeneous Helmholtz equation (see e.g., Soubies *et al.* [[155](https://deepinv.org/user_guide/other/biblio.md#id19)]):
...
```none
Selected GPU 0 with 1029.25 MiB free memory
```
...
[`deepinv.physics.Scattering.SolverConfig`](https://deepinv.org/api/stubs/deepinv.physics.Scattering.md#deepinv.physics.Scattering.SolverConfig) for more details).
...
gradient evaluation (see e.g. Soubies *et al.* [[155](https://deepinv.org/user_guide/other/biblio.md#id19)]), and does not require storing all intermediate variables (as in standard backpropagation via PyTorch autograd).
...
Peak GPU memory usage for grad computation: 494.8 MB
Peak GPU memory usage for grad computation: 613.7 MB
...
- Use a pretrained denoiser to perform plug-and-play reconstruction, as in [Vanilla PnP for computed tomography (CT).](https://deepinv.org/auto_examples/plug-and-play/demo_vanilla_PnP.md#sphx-glr-auto-examples-plug-and-play-demo-vanilla-pnp-py)
- Learn a reconstruction network using an unrolled architecture, as in [Vanilla Unfolded algorithm for super-resolution](https://deepinv.org/auto_examples/unfolded/demo_vanilla_unfolded.md#sphx-glr-auto-examples-unfolded-demo-vanilla-unfolded-py).
...
[`Download Jupyter notebook: demo_scattering.ipynb`](https://deepinv.org/auto_examples/physics/_downloads/96a631387aec4a1a9994f425f58e4c2f/demo_scattering.ipynb)

[`Download Python source code: demo_scattering.py`](https://deepinv.org/auto_examples/physics/_downloads/636aee0006e3b12703cec5a1c2e90517/demo_scattering.py)

[`Download zipped: demo_scattering.zip`](https://deepinv.org/auto_examples/physics/_downloads/28a56bea992e3841a3eef1bfb974fbd8/demo_scattering.zip)
