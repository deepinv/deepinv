...
In this example we show how to use the [`deepinv.physics.SinglePhotonLidar`](https://deepinv.org/api/stubs/deepinv.physics.SinglePhotonLidar.md#deepinv.physics.SinglePhotonLidar) forward model.
