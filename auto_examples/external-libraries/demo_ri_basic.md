...
Below, we propose an implementation using the [`deepinv.physics.LinearPhysics`](https://deepinv.org/api/stubs/deepinv.physics.LinearPhysics.md#deepinv.physics.LinearPhysics).
...
This measurement operator is readily available in the Physics module in [`deepinv.physics.RadioInterferometry`](https://deepinv.org/api/stubs/deepinv.physics.RadioInterferometry.md#deepinv.physics.RadioInterferometry)
...
with the help of the [`deepinv.utils.dirac_like()`](https://deepinv.org/api/stubs/deepinv.utils.dirac_like.md#deepinv.utils.dirac_like) function.
