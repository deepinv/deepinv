...
We model the 2D non-uniform FFT physics with [`deepinv.physics.NonCartesianMRI`](https://deepinv.org/api/stubs/deepinv.physics.NonCartesianMRI.md#deepinv.physics.NonCartesianMRI), which uses [MRI-NUFFT](https://github.com/mind-inria/mri-nufft).
...
The final kspace should be of shape `(1,2,N,S)` to be used with [`deepinv.physics.NonCartesianMRI`](https://deepinv.org/api/stubs/deepinv.physics.NonCartesianMRI.md#deepinv.physics.NonCartesianMRI).
...
[`Download Jupyter notebook: demo_mrinufft_breast.ipynb`](https://deepinv.org/auto_examples/external-libraries/_downloads/3456e8709b3bcf09ac8086ea5cfcb925/demo_mrinufft_breast.ipynb)

[`Download Python source code: demo_mrinufft_breast.py`](https://deepinv.org/auto_examples/external-libraries/_downloads/2a8350da703287b878b7fd0eabae0ac6/demo_mrinufft_breast.py)

[`Download zipped: demo_mrinufft_breast.zip`](https://deepinv.org/auto_examples/external-libraries/_downloads/3325618e91c2fab9bee2a325c09fa669/demo_mrinufft_breast.zip)
