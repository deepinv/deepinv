...
```none
/local/jtachell/deepinv/deepinv/deepinv/utils/plotting.py:725: UserWarning: No data for colormapping provided via 'c'. Parameters 'cmap' will be ignored
  axs[r, i].scatter(
/local/jtachell/deepinv/deepinv/deepinv/utils/plotting.py:744: UserWarning: This figure was using a layout engine that is incompatible with subplots_adjust and/or tight_layout; not calling subplots_adjust.
...
[`Download Jupyter notebook: demo_ri_basic.ipynb`](https://deepinv.org/auto_examples/external-libraries/_downloads/d9a6d1de7a26f95dd13357cfa1a1ac87/demo_ri_basic.ipynb)

[`Download Python source code: demo_ri_basic.py`](https://deepinv.org/auto_examples/external-libraries/_downloads/2cd7326f3db6091e146254365070f98d/demo_ri_basic.py)

[`Download zipped: demo_ri_basic.zip`](https://deepinv.org/auto_examples/external-libraries/_downloads/b2604cfae39cf6c163be3c1dc09dd97f/demo_ri_basic.zip)
