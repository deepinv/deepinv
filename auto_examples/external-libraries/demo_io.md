...
directly using [`deepinv.utils.load_dicom()`](https://deepinv.org/api/stubs/deepinv.utils.load_dicom.md#deepinv.utils.load_dicom). Here, we demonstrate on a
...
NIfTI files are often used for volumetric neuroimaging data. We load them using [`deepinv.utils.load_nifti()`](https://deepinv.org/api/stubs/deepinv.utils.load_nifti.md#deepinv.utils.load_nifti).
...
ISMRMRD is a standard raw MRI k-space format. We load a k-space slice using [`deepinv.utils.load_ismrmd()`](https://deepinv.org/api/stubs/deepinv.utils.load_ismrmd.md#deepinv.utils.load_ismrmd)
...
See [`deepinv.utils.load_raster()`](https://deepinv.org/api/stubs/deepinv.utils.load_raster.md#deepinv.utils.load_raster) for patch options.
