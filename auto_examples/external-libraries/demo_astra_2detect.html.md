...
```none
Selected GPU 0 with 229.25 MiB free memory
```
...
<!-- GENERATED FROM PYTHON SOURCE LINES 182-219 -->
```Python
...
<!-- GENERATED FROM PYTHON SOURCE LINES 238-259 -->
```Python
...
Test: 100%|██████████| 1/1 [00:05<00:00,  5.44s/it, PSNR=39.2, PSNR no learning=34.6]
Test: 100%|██████████| 1/1 [00:05<00:00,  5.44s/it, PSNR=39.2, PSNR no learning=34.6]
Test results:
PSNR no learning: 34.606 +- 0.007
PSNR: 39.193 +- 0.006

{'PSNR no learning': 34.6063232421875, 'PSNR no learning_std': 0.006921505128093182, 'PSNR': 39.19294738769531, 'PSNR_std': 0.00576788281605742, 'runtime': 5.4461805410683155, 'peak_gpu_memory_usage': 3.5526304244995117}
```
...
<!-- GENERATED FROM PYTHON SOURCE LINES 333-391 -->
```Python
proj_geom = astra.create_proj_geom(
...
**Total running time of the script:** (1 minutes 2.607 seconds)
