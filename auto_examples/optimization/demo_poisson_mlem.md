...
The [`deepinv.optim.MLEM`](https://deepinv.org/api/stubs/deepinv.optim.MLEM.md#deepinv.optim.MLEM) class wraps the MLEM iterations.
...
Any prior implementing the [`deepinv.optim.prior.Prior`](https://deepinv.org/api/stubs/deepinv.optim.Prior.md#deepinv.optim.Prior) interface can be used in the [`deepinv.optim.MLEM`](https://deepinv.org/api/stubs/deepinv.optim.MLEM.md#deepinv.optim.MLEM) class, and the proximal step is automatically computed when needed.
