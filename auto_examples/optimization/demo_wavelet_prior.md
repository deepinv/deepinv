...
In this example, we will use the wavelet prior, which can be done with the [`deepinv.optim.prior.WaveletPrior`](https://deepinv.org/api/stubs/deepinv.optim.WaveletPrior.md#deepinv.optim.WaveletPrior)
...
[`Download Jupyter notebook: demo_wavelet_prior.ipynb`](https://deepinv.org/auto_examples/optimization/_downloads/911df7df50f007a2879a13f81b463c06/demo_wavelet_prior.ipynb)

[`Download Python source code: demo_wavelet_prior.py`](https://deepinv.org/auto_examples/optimization/_downloads/b433351eca3ca5f114ecae6a43c54c9b/demo_wavelet_prior.py)

[`Download zipped: demo_wavelet_prior.zip`](https://deepinv.org/auto_examples/optimization/_downloads/3834849204a1442923bc0c362fcca629/demo_wavelet_prior.zip)
