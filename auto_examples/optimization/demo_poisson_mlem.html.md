...
```none
Selected GPU 0 with 7613.25 MiB free memory
```
...
[`Download Jupyter notebook: demo_poisson_mlem.ipynb`](https://deepinv.org/auto_examples/optimization/_downloads/7995a858ee9f9a7ca83a0681697c7f54/demo_poisson_mlem.ipynb)

[`Download Python source code: demo_poisson_mlem.py`](https://deepinv.org/auto_examples/optimization/_downloads/82493f55f99d50124eb630e77365c6e4/demo_poisson_mlem.py)

[`Download zipped: demo_poisson_mlem.zip`](https://deepinv.org/auto_examples/optimization/_downloads/60d918eecb01af8478ee1bdf52acb2a6/demo_poisson_mlem.zip)
