...
This example shows how to fit [`deepinv.loss.metric.NIQE`](https://deepinv.org/api/stubs/deepinv.loss.metric.NIQE.md#deepinv.loss.metric.NIQE) on a new dataset, and use it
...
Constructing [`deepinv.loss.metric.NIQE`](https://deepinv.org/api/stubs/deepinv.loss.metric.NIQE.md#deepinv.loss.metric.NIQE) without an explicit `weights_path`
...
[`deepinv.loss.metric.NIQE.create_weights()`](https://deepinv.org/api/stubs/deepinv.loss.metric.NIQE.md#deepinv.loss.metric.NIQE.create_weights) with a dataset of pristine images.
