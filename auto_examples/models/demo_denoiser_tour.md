...
DeepInverse provides a set of classical denoisers such as [`deepinv.models.BM3D`](https://deepinv.org/api/stubs/deepinv.models.BM3D.md#deepinv.models.BM3D),
[`deepinv.models.TGVDenoiser`](https://deepinv.org/api/stubs/deepinv.models.TGVDenoiser.md#deepinv.models.TGVDenoiser), or [`deepinv.models.WaveletDictDenoiser`](https://deepinv.org/api/stubs/deepinv.models.WaveletDictDenoiser.md#deepinv.models.WaveletDictDenoiser).
...
- *Fixed-noise level denoisers:* Some denoisers are trained to be able to recover
  ...
  of [`deepinv.models.DnCNN`](https://deepinv.org/api/stubs/deepinv.models.DnCNN.md#deepinv.models.DnCNN) or [`deepinv.models.SwinIR`](https://deepinv.org/api/stubs/deepinv.models.SwinIR.md#deepinv.models.SwinIR).
- *Adaptive-level denoisers:* These denoisers are able to adapt to the noise level
  ...
  value `sigma` given as an input. This is typically the case for [`deepinv.models.BM3D`](https://deepinv.org/api/stubs/deepinv.models.BM3D.md#deepinv.models.BM3D),
  [`deepinv.models.SCUNet`](https://deepinv.org/api/stubs/deepinv.models.SCUNet.md#deepinv.models.SCUNet), or [`deepinv.models.DRUNet`](https://deepinv.org/api/stubs/deepinv.models.DRUNet.md#deepinv.models.DRUNet), but also for denoisers based on regularisations
  like [`deepinv.models.WaveletDictDenoiser`](https://deepinv.org/api/stubs/deepinv.models.WaveletDictDenoiser.md#deepinv.models.WaveletDictDenoiser).
...
- *Blind denoisers:* These denoisers estimate the level of noise in the input image
  to output the cleanest image possible. Example of blind denoisers are [`deepinv.models.SCUNet`](https://deepinv.org/api/stubs/deepinv.models.SCUNet.md#deepinv.models.SCUNet)
  or [`deepinv.models.Restormer`](https://deepinv.org/api/stubs/deepinv.models.Restormer.md#deepinv.models.Restormer).
...
We see that overall [`deepinv.models.DRUNet`](https://deepinv.org/api/stubs/deepinv.models.DRUNet.md#deepinv.models.DRUNet) achieves the best performances for all
...
like [`deepinv.models.WaveletDictDenoiser`](https://deepinv.org/api/stubs/deepinv.models.WaveletDictDenoiser.md#deepinv.models.WaveletDictDenoiser), are not well adapted to the noise level.
...
the performances of [`deepinv.models.WaveletDictDenoiser`](https://deepinv.org/api/stubs/deepinv.models.WaveletDictDenoiser.md#deepinv.models.WaveletDictDenoiser) once the threshold have been tuned
...
[pretrained-weights](https://deepinv.org/user_guide/reconstruction/pretrained-models.md#pretrained-weights) for more details on the chose noise level.
