...
* Deep learning, using a pretrained general model [`deepinv.models.RAM`](https://deepinv.org/api/stubs/deepinv.models.RAM.md#deepinv.models.RAM) from Terris *et al.*<sup>[2](#footcite-terris2025reconstruct)</sup>
