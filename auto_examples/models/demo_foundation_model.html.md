...
Model, optimizer, epoch_start successfully loaded from checkpoint: 26-09-16-16:46:56/ckp_best.pth.tar
```
...
**Total running time of the script:** (0 minutes 30.005 seconds)
