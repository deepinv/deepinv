...
```none
Denoiser DRUNet... done (2.38s)
Denoiser SCUNet... done (2.99s)
Denoiser DnCNN... done (0.65s)
Denoiser BM3D... done (51.17s)
Denoiser Wavelet... done (1.15s)
```
...
```none
Denoiser DnCNN (adapted)... done (0.48s)
```
...
**Total running time of the script:** (1 minutes 38.606 seconds)
