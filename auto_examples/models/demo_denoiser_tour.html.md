...
```none
Denoiser DRUNet... done (2.67s)
Denoiser SCUNet... done (3.33s)
Denoiser DnCNN... done (0.65s)
Denoiser BM3D... done (51.15s)
Denoiser Wavelet... done (0.98s)
```
...
```none
Denoiser DnCNN (adapted)... done (0.47s)
```
...
**Total running time of the script:** (1 minutes 44.907 seconds)

🏷 Tags: Denoising

<a id="sphx-glr-download-auto-examples-models-demo-denoiser-tour-py"></a>

[`Download Jupyter notebook: demo_denoiser_tour.ipynb`](https://deepinv.org/auto_examples/models/_downloads/9c03b25d90135773ac5f94ab4e956515/demo_denoiser_tour.ipynb)

[`Download Python source code: demo_denoiser_tour.py`](https://deepinv.org/auto_examples/models/_downloads/35472d9f8b39f45878112fcac713778f/demo_denoiser_tour.py)

[`Download zipped: demo_denoiser_tour.zip`](https://deepinv.org/auto_examples/models/_downloads/aa842ef0ee1219fc462289e310b81760/demo_denoiser_tour.zip)
