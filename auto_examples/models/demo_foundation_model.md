...
The [`Reconstruct Anything Model`](https://deepinv.org/api/stubs/deepinv.models.RAM.md#deepinv.models.RAM) is a model that has been trained to work on a large
...
**even in the absence of ground truth data**, using a [self-supervised loss](https://deepinv.org/user_guide/training/loss.md#self-supervised-losses),
...
#### NOTE
You can also fine-tune on larger datasets if you want, by replacing the [dataset](https://deepinv.org/user_guide/training/datasets.md#datasets).
...
Model, optimizer, epoch_start successfully loaded from checkpoint: 26-09-26-10:08:29/ckp_best.pth.tar
```
...
[`Download Jupyter notebook: demo_foundation_model.ipynb`](https://deepinv.org/auto_examples/models/_downloads/5c783cb6918979bb435930bf56879cf9/demo_foundation_model.ipynb)

[`Download Python source code: demo_foundation_model.py`](https://deepinv.org/auto_examples/models/_downloads/54e128e1ef6969ed4a1e53d43a1e33ed/demo_foundation_model.py)

[`Download zipped: demo_foundation_model.zip`](https://deepinv.org/auto_examples/models/_downloads/afc11b6f0a46d1004aa6c9eeab1f2e14/demo_foundation_model.zip)
