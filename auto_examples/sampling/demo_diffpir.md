...
The full algorithm is implemented in [`deepinv.sampling.DiffPIR`](https://deepinv.org/api/stubs/deepinv.sampling.DiffPIR.md#deepinv.sampling.DiffPIR).
...
which for Gaussian Noise (implemented as [`deepinv.optim.data_fidelity.L2`](https://deepinv.org/api/stubs/deepinv.optim.L2.md#deepinv.optim.L2)) is given by:
...
Note that other data fidelity terms can be used, such as [`deepinv.optim.PoissonLikelihood`](https://deepinv.org/api/stubs/deepinv.optim.PoissonLikelihood.md#deepinv.optim.PoissonLikelihood).
...
<!-- GENERATED FROM PYTHON SOURCE LINES 246-295 -->
```Python
...
<!-- GENERATED FROM PYTHON SOURCE LINES 324-388 -->
```Python
# Initialization
...
```none
  0%|          | 0/30 [00:00<?, ?it/s]
  7%|▋         | 2/30 [00:00<00:02, 13.92it/s]
 13%|█▎        | 4/30 [00:00<00:01, 14.01it/s]
 20%|██        | 6/30 [00:00<00:01, 14.05it/s]
 27%|██▋       | 8/30 [00:00<00:01, 14.10it/s]
 33%|███▎      | 10/30 [00:00<00:01, 14.14it/s]
 40%|████      | 12/30 [00:00<00:01, 14.17it/s]
 47%|████▋     | 14/30 [00:00<00:01, 14.18it/s]
 53%|█████▎    | 16/30 [00:01<00:00, 14.19it/s]
 60%|██████    | 18/30 [00:01<00:00, 14.20it/s]
 67%|██████▋   | 20/30 [00:01<00:00, 14.21it/s]
 73%|███████▎  | 22/30 [00:01<00:00, 14.22it/s]
 80%|████████  | 24/30 [00:01<00:00, 14.21it/s]
 87%|████████▋ | 26/30 [00:01<00:00, 14.21it/s]
 93%|█████████▎| 28/30 [00:01<00:00, 14.22it/s]
...
You can readily use this algorithm via the [`deepinv.sampling.DiffPIR`](https://deepinv.org/api/stubs/deepinv.sampling.DiffPIR.md#deepinv.sampling.DiffPIR) class.
...
[`Download Jupyter notebook: demo_diffpir.ipynb`](https://deepinv.org/auto_examples/sampling/_downloads/7fafb07c666d87a0ea165fb51bf6dd14/demo_diffpir.ipynb)

[`Download Python source code: demo_diffpir.py`](https://deepinv.org/auto_examples/sampling/_downloads/2fd33144d585f8296df70a82175d402e/demo_diffpir.py)

[`Download zipped: demo_diffpir.zip`](https://deepinv.org/auto_examples/sampling/_downloads/6ed3a3b3dc1983f1a75109719cabf875/demo_diffpir.zip)
