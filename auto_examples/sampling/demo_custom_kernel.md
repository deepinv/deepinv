...
We modify the standard ULA iteration (see [`deepinv.sampling.ULAIterator`](https://deepinv.org/api/stubs/deepinv.sampling.ULAIterator.md#deepinv.sampling.ULAIterator)) defined as
...
We exploit the methods of [`deepinv.physics.DecomposablePhysics`](https://deepinv.org/api/stubs/deepinv.physics.DecomposablePhysics.md#deepinv.physics.DecomposablePhysics) to compute the matrix-vector products
...
See [`deepinv.sampling.BaseSampling`](https://deepinv.org/api/stubs/deepinv.sampling.BaseSampling.md#deepinv.sampling.BaseSampling) for more details on how to create new iterators.
...
Using our custom iterator, we can build a sampler class by calling [`deepinv.sampling.sampling_builder()`](https://deepinv.org/api/stubs/deepinv.sampling.sampling_builder.md#deepinv.sampling.sampling_builder)
This function returns an instance of [`deepinv.sampling.BaseSampling`](https://deepinv.org/api/stubs/deepinv.sampling.BaseSampling.md#deepinv.sampling.BaseSampling) which takes care of the sampling procedure
...
(e.g. which inherit from [`deepinv.physics.DecomposablePhysics`](https://deepinv.org/api/stubs/deepinv.physics.DecomposablePhysics.md#deepinv.physics.DecomposablePhysics)) and the noise to be Gaussian,
