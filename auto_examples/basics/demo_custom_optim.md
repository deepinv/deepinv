...
2. How to package it as a [`reconstructor model`](https://deepinv.org/api/stubs/deepinv.models.Reconstructor.md#deepinv.models.Reconstructor)
3. How to use define new optimization algorithm as a subclass of [`BaseOptim`](https://deepinv.org/api/stubs/deepinv.optim.BaseOptim.md#deepinv.optim.BaseOptim)
...
The library provides a set of [data fidelity](https://deepinv.org/user_guide/reconstruction/optimization.md#data-fidelity) terms and [priors](https://deepinv.org/user_guide/reconstruction/optimization.md#priors)
...
The library provides [a collection of classical and pretrained denoisers](https://deepinv.org/user_guide/reconstruction/denoisers.md#denoisers)
...
The iterative algorithm we defined above can be packaged as a [`Reconstructor`](https://deepinv.org/api/stubs/deepinv.models.Reconstructor.md#deepinv.models.Reconstructor).
This allows you to [`test it`](https://deepinv.org/api/stubs/deepinv.test.md#deepinv.test) on different physics and datasets, and to use it in a more flexible way,
...
* Check out more about optimization algorithms in the [optimization user guide](https://deepinv.org/user_guide/reconstruction/optimization.md#optim).
* Check out diffusion and MCMC iterative algorithms in the [sampling user guide](https://deepinv.org/user_guide/reconstruction/sampling.md#sampling).
* Check out more [iterative algorithms examples](https://deepinv.org/auto_examples/optimization/index.md#sphx-glr-auto-examples-optimization).
* Check out how to try the algorithm on a whole dataset by following the [bring your own dataset](https://deepinv.org/auto_examples/basics/demo_custom_dataset.md#sphx-glr-auto-examples-basics-demo-custom-dataset-py) tutorial.
* Check out how to train your plug-and-play algorithm by unfolding its iterations in the [vanilla unfolded](https://deepinv.org/auto_examples/unfolded/demo_vanilla_unfolded.md#sphx-glr-auto-examples-unfolded-demo-vanilla-unfolded-py) tutorial.
