...
While DeepInverse offers a [large number of forward operators](https://deepinv.org/user_guide/physics/physics.md#physics),
you can also bring your own forward operator for your specific imaging problem.

DeepInverse’s modular [physics framework](https://deepinv.org/user_guide/physics/intro.md#physics-intro) makes this easy by letting you inherit useful methods from the most appropriate
physics base class:

* [`deepinv.physics.Physics`](https://deepinv.org/api/stubs/deepinv.physics.Physics.md#deepinv.physics.Physics) for non-linear operators;
* [`deepinv.physics.LinearPhysics`](https://deepinv.org/api/stubs/deepinv.physics.LinearPhysics.md#deepinv.physics.LinearPhysics) for linear operators;
* [`deepinv.physics.DecomposablePhysics`](https://deepinv.org/api/stubs/deepinv.physics.DecomposablePhysics.md#deepinv.physics.DecomposablePhysics) for linear operators with a closed-form singular value decomposition.

#### SEE ALSO
Often your physics can be modelled without much work. You could:

* Use an existing physics but with custom `params`, e.g. blur with a custom kernel, or MRI with a custom sampling pattern. See [parameter dependent operators](https://deepinv.org/user_guide/physics/intro.md#parameter-dependent-operators).
* Inherit from an existing physics but override or wrap a particular method e.g. [`deepinv.physics.MRI`](https://deepinv.org/api/stubs/deepinv.physics.MRI.md#deepinv.physics.MRI) $\rightarrow$ [`deepinv.physics.DynamicMRI`](https://deepinv.org/api/stubs/deepinv.physics.DynamicMRI.md#deepinv.physics.DynamicMRI)
* Define a new operator by [combining existing operators](https://deepinv.org/user_guide/physics/intro.md#physics-combining).
...
inheriting the remaining structure of the [`deepinv.physics.LinearPhysics`](https://deepinv.org/api/stubs/deepinv.physics.LinearPhysics.md#deepinv.physics.LinearPhysics) class.

Once the operator is defined, we can use any of the functions in the [`deepinv.physics.Physics`](https://deepinv.org/api/stubs/deepinv.physics.Physics.md#deepinv.physics.Physics) class and
[`deepinv.physics.LinearPhysics`](https://deepinv.org/api/stubs/deepinv.physics.LinearPhysics.md#deepinv.physics.LinearPhysics) class, such as computing the norm of the operator, testing the adjointness,
computing the proximal operator, etc.

#### TIP
By default, the adjoint of a [`LinearPhysics`](https://deepinv.org/api/stubs/deepinv.physics.LinearPhysics.md#deepinv.physics.LinearPhysics) is computed using autograd with [`deepinv.physics.adjoint_function`](https://deepinv.org/api/stubs/deepinv.physics.adjoint_function.md#deepinv.physics.adjoint_function).
...
#### TIP
Inherit from [mixin](https://deepinv.org/user_guide/other/utils.md#mixin) classes to provide specialized methods for your physics.
...
It is often useful for reconstruction algorithms that the physics has unit norm, which you can verify using [`deepinv.physics.LinearPhysics.compute_norm()`](https://deepinv.org/api/stubs/deepinv.physics.LinearPhysics.md#deepinv.physics.LinearPhysics.compute_norm).
...
[`deepinv.physics.LinearPhysics.A_adjoint()`](https://deepinv.org/api/stubs/deepinv.physics.LinearPhysics.md#deepinv.physics.LinearPhysics.A_adjoint), instead of relying on
[`autodifferentiation`](https://deepinv.org/api/stubs/deepinv.physics.adjoint_function.md#deepinv.physics.adjoint_function) which is generally less efficient.
...
[`deepinv.physics.LinearPhysics.adjointness_test()`](https://deepinv.org/api/stubs/deepinv.physics.LinearPhysics.md#deepinv.physics.LinearPhysics.adjointness_test).
...
you should instead implement the operator using the [`deepinv.physics.DecomposablePhysics`](https://deepinv.org/api/stubs/deepinv.physics.DecomposablePhysics.md#deepinv.physics.DecomposablePhysics) base class.
...
proximal operator and the linear pseudo-inverse. Moreover, some algorithms, such as [`deepinv.sampling.DDRM`](https://deepinv.org/api/stubs/deepinv.sampling.DDRM.md#deepinv.sampling.DDRM)
...
* Check out [the example on how to inference a state-of-the-art general pretrained model](https://deepinv.org/auto_examples/basics/demo_pretrained_model.md#sphx-glr-auto-examples-basics-demo-pretrained-model-py) with your new physics.
* Check out the [example on how to fine-tune a foundation model](https://deepinv.org/auto_examples/models/demo_foundation_model.md#sphx-glr-auto-examples-models-demo-foundation-model-py) to your own physics.
