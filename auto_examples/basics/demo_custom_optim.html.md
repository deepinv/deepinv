...
**Total running time of the script:** (1 minutes 27.460 seconds)

🏷 Tags: Denoising, Basics

<a id="sphx-glr-download-auto-examples-basics-demo-custom-optim-py"></a>

[`Download Jupyter notebook: demo_custom_optim.ipynb`](https://deepinv.org/auto_examples/basics/_downloads/668aaf9486d14254f2aa626a3af40caf/demo_custom_optim.ipynb)

[`Download Python source code: demo_custom_optim.py`](https://deepinv.org/auto_examples/basics/_downloads/32bef9af80fae187170d064a3abf6731/demo_custom_optim.py)

[`Download zipped: demo_custom_optim.zip`](https://deepinv.org/auto_examples/basics/_downloads/e7f286054842b740af000788a314525c/demo_custom_optim.zip)
