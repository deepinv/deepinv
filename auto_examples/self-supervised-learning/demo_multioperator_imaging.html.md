...
Eval epoch 0: MCLoss=0.0, MOILoss=0.0, TotalLoss=0.0, PSNR=14.075, PSNR no learning=13.634
Test results:
PSNR no learning: 13.634 +- 1.998
PSNR: 14.075 +- 1.974

{'PSNR no learning': 13.633685493469239, 'PSNR no learning_std': 1.9978854081703776, 'PSNR': 14.074813079833984, 'PSNR_std': 1.9738107513112888, 'runtime': 0.3133887159638107, 'peak_gpu_memory_usage': 0.19611740112304688}
```
...
**Total running time of the script:** (2 minutes 31.216 seconds)
