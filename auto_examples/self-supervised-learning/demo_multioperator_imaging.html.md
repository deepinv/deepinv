...
```none
Eval epoch 0: MCLoss=0.0, MOILoss=0.0, TotalLoss=0.0, PSNR=14.063, PSNR no learning=13.634
Test results:
PSNR no learning: 13.634 +- 1.998
PSNR: 14.063 +- 1.923

{'PSNR no learning': 13.633685493469239, 'PSNR no learning_std': 1.9978854081703776, 'PSNR': 14.063489246368409, 'PSNR_std': 1.9232665224055394, 'runtime': 0.3097790880128741, 'peak_gpu_memory_usage': 0.54754638671875}
```
...
**Total running time of the script:** (2 minutes 31.148 seconds)
