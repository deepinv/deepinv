...
Eval epoch 0: TotalLoss=0.015, PSNR=6.443, PSNR no learning=-7.502
Test results:
PSNR no learning: -7.502 +- 0.400
PSNR: 6.443 +- 0.623

{'PSNR no learning': -7.5021203517913815, 'PSNR no learning_std': 0.3999075731732372, 'PSNR': 6.443373394012451, 'PSNR_std': 0.6231152650830604, 'runtime': 9.586007119040005, 'peak_gpu_memory_usage': 0.08036279678344727}
```
...
```none
Eval epoch 0: TotalLoss=0.015, PSNR=2.946, PSNR no learning=-7.524
Test results:
PSNR no learning: -7.524 +- 0.399
PSNR: 2.946 +- 0.682

{'PSNR no learning': -7.523556900024414, 'PSNR no learning_std': 0.39911634627214526, 'PSNR': 2.946005666255951, 'PSNR_std': 0.681597037881818, 'runtime': 4.1783529670210555, 'peak_gpu_memory_usage': 0.08034229278564453}
```
...
```none
Eval epoch 0: TotalLoss=0.015, PSNR=0.32, PSNR no learning=-7.492
Test results:
PSNR no learning: -7.492 +- 0.383
PSNR: 0.320 +- 0.524

{'PSNR no learning': -7.4924314498901365, 'PSNR no learning_std': 0.38328919229174035, 'PSNR': 0.3195045180618763, 'PSNR_std': 0.523853665442311, 'runtime': 4.087979557923973, 'peak_gpu_memory_usage': 0.08033323287963867}
```
