...
```none
Selected GPU 0 with 1095.25 MiB free memory
```
...
```none
Eval epoch 0: TotalLoss=0.015, PSNR=6.452, PSNR no learning=-7.536
Test results:
PSNR no learning: -7.536 +- 0.373
PSNR: 6.452 +- 0.625

{'PSNR no learning': -7.535984373092651, 'PSNR no learning_std': 0.373087999614692, 'PSNR': 6.4524054527282715, 'PSNR_std': 0.6251333649264517, 'runtime': 9.595791843021289, 'peak_gpu_memory_usage': 0.4326462745666504}
```
...
```none
Eval epoch 0: TotalLoss=0.015, PSNR=2.957, PSNR no learning=-7.522
Test results:
PSNR no learning: -7.522 +- 0.371
PSNR: 2.957 +- 0.684

{'PSNR no learning': -7.521739196777344, 'PSNR no learning_std': 0.3708290208365197, 'PSNR': 2.9569859743118285, 'PSNR_std': 0.683692824131721, 'runtime': 4.2034324400592595, 'peak_gpu_memory_usage': 0.43262577056884766}
```
...
```none
Eval epoch 0: TotalLoss=0.015, PSNR=0.351, PSNR no learning=-7.533
Test results:
PSNR no learning: -7.533 +- 0.402
PSNR: 0.351 +- 0.526

{'PSNR no learning': -7.532988500595093, 'PSNR no learning_std': 0.4016636660014026, 'PSNR': 0.35086250156164167, 'PSNR_std': 0.5258268883973991, 'runtime': 4.085107613820583, 'peak_gpu_memory_usage': 0.4326167106628418}
```
