...
<!-- GENERATED FROM PYTHON SOURCE LINES 166-201 -->
```Python
...
{'PSNR no learning': 19.487266845703125, 'PSNR no learning_std': 1.6277921401540443, 'PSNR': 26.122406158447266, 'PSNR_std': 1.4331835700495887, 'runtime': 0.34871779300738126, 'peak_gpu_memory_usage': 0.3398714065551758}
```
