...
See [docs](https://deepinv.org/user_guide/training/transforms.md#transform) for full list of available transforms.
...
{'PSNR no learning': 32.74856948852539, 'PSNR no learning_std': 0.0, 'PSNR': 37.51628494262695, 'PSNR_std': 0.0066174860900851205, 'runtime': 0.16237950883805752, 'peak_gpu_memory_usage': 0.7996878623962402}
```
...
**Total running time of the script:** (14 minutes 49.258 seconds)

<a id="sphx-glr-download-auto-examples-self-supervised-learning-demo-equivariant-imaging-py"></a>

[`Download Jupyter notebook: demo_equivariant_imaging.ipynb`](https://deepinv.org/auto_examples/self-supervised-learning/_downloads/fff43dcb7e01ba08f91d580209308dce/demo_equivariant_imaging.ipynb)

[`Download Python source code: demo_equivariant_imaging.py`](https://deepinv.org/auto_examples/self-supervised-learning/_downloads/cc2dd3ba2cedc98abbfca9b6e4a8dd51/demo_equivariant_imaging.py)

[`Download zipped: demo_equivariant_imaging.zip`](https://deepinv.org/auto_examples/self-supervised-learning/_downloads/b313b423aa792cc8a70bf9aea60f7d63/demo_equivariant_imaging.zip)
