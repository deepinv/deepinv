...
```none
Selected GPU 0 with 3529.25 MiB free memory
```
...
{'PSNR no learning': 20.058787994384765, 'PSNR no learning_std': 0.2240126492605046, 'PSNR': 23.190016326904296, 'PSNR_std': 0.6302945151918853, 'runtime': 0.36707566189579666, 'peak_gpu_memory_usage': 0.6887984275817871}
```
...
**Total running time of the script:** (0 minutes 23.162 seconds)
