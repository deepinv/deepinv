...
```none
/local/jtachell/deepinv/deepinv/deepinv/datasets/datagenerator.py:619: UserWarning: Dataset measurements/MNIST/denoising/demo_sure0.h5 already exists, this will close and overwrite the previous dataset.
  warn(
...
{'PSNR no learning': 20.058787994384765, 'PSNR no learning_std': 0.2240126492605046, 'PSNR': 23.190016326904296, 'PSNR_std': 0.6302945151918853, 'runtime': 0.37800084659829736, 'peak_gpu_memory_usage': 0.6887984275817871}
```
...
**Total running time of the script:** (0 minutes 24.085 seconds)

🏷 Tags: Denoising

<a id="sphx-glr-download-auto-examples-self-supervised-learning-demo-unsure-py"></a>

[`Download Jupyter notebook: demo_unsure.ipynb`](https://deepinv.org/auto_examples/self-supervised-learning/_downloads/a93eacd4f70ad92a1331c4edda61323c/demo_unsure.ipynb)

[`Download Python source code: demo_unsure.py`](https://deepinv.org/auto_examples/self-supervised-learning/_downloads/518ecf2dacdfacdd54a16c23e171e967/demo_unsure.py)

[`Download zipped: demo_unsure.zip`](https://deepinv.org/auto_examples/self-supervised-learning/_downloads/07fcc872818acf2ba73cb7694ddfa5cd/demo_unsure.zip)
