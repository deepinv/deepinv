...
<!-- GENERATED FROM PYTHON SOURCE LINES 67-108 -->
```Python
# defined physics
...
<!-- GENERATED FROM PYTHON SOURCE LINES 161-198 -->
```Python
...
{'PSNR no learning': 12.572514038085938, 'PSNR no learning_std': 1.7226337202107147, 'PSNR': 20.526467895507814, 'PSNR_std': 1.701686465961638, 'runtime': 0.32010164600797, 'peak_gpu_memory_usage': 0.39366769790649414}
```
