...
```none
Selected GPU 0 with 3528.25 MiB free memory
```
...
{'PSNR no learning': 32.74856948852539, 'PSNR no learning_std': 0.0, 'PSNR': 37.51628494262695, 'PSNR_std': 0.0066174860900851205, 'runtime': 0.1608169749379158, 'peak_gpu_memory_usage': 0.7996878623962402}
```
...
**Total running time of the script:** (14 minutes 15.414 seconds)
