...
**Total running time of the script:** (1 minutes 59.577 seconds)

🏷 Tags: MRI, Foundation model

<a id="sphx-glr-download-auto-examples-self-supervised-learning-demo-scan-specific-py"></a>

[`Download Jupyter notebook: demo_scan_specific.ipynb`](https://deepinv.org/auto_examples/self-supervised-learning/_downloads/dab47d9d233ee5834e1a29b48217767a/demo_scan_specific.ipynb)

[`Download Python source code: demo_scan_specific.py`](https://deepinv.org/auto_examples/self-supervised-learning/_downloads/7ffb503a30562de1d548f79e11d4acc8/demo_scan_specific.py)

[`Download zipped: demo_scan_specific.zip`](https://deepinv.org/auto_examples/self-supervised-learning/_downloads/8fa417c2f3f659a045b2bfee5aed3ba8/demo_scan_specific.zip)
