...
Here, we demonstrate fine-tuning a pretrained model ([`deepinv.models.RAM`](https://deepinv.org/api/stubs/deepinv.models.RAM.md#deepinv.models.RAM)) <sup>[1](#footcite-terris2025reconstruct)</sup>
with the [`weighted SSDU`](https://deepinv.org/api/stubs/deepinv.loss.mri.WeightedSplittingLoss.md#deepinv.loss.mri.WeightedSplittingLoss) loss <sup>[2](#footcite-millard2023theoretical)</sup><sup>[3](#footcite-yaman2020self)</sup>.
However, note that any of the [self-supervised losses](https://deepinv.org/user_guide/training/loss.md#self-supervised-losses) can be used to do this with varying performance <sup>[4](#footcite-wang2025benchmarking)</sup>.
For example see the [example using Equivariant Imaging](https://deepinv.org/auto_examples/self-supervised-learning/demo_equivariant_imaging.md#sphx-glr-auto-examples-self-supervised-learning-demo-equivariant-imaging-py) <sup>[5](#footcite-chen2021equivariant)</sup>.
...
For the model we fine-tune a pretrained model ([`deepinv.models.RAM`](https://deepinv.org/api/stubs/deepinv.models.RAM.md#deepinv.models.RAM)) <sup>[1](#footcite-terris2025reconstruct)</sup>
