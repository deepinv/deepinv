...
If the [`deepinv.datasets.generate_dataset()`](https://deepinv.org/api/stubs/deepinv.datasets.generate_dataset.md#deepinv.datasets.generate_dataset) receives a list of physics operators, it
...
```none
Eval epoch 0: MCLoss=0.0, MOILoss=0.0, TotalLoss=0.0, PSNR=14.09, PSNR no learning=13.634
Test results:
PSNR no learning: 13.634 +- 1.998
PSNR: 14.090 +- 2.020

{'PSNR no learning': 13.633685493469239, 'PSNR no learning_std': 1.9978854081703776, 'PSNR': 14.08990306854248, 'PSNR_std': 2.0199739648415656, 'runtime': 0.25884046917781234, 'peak_gpu_memory_usage': 0.54754638671875}
```
...
**Total running time of the script:** (2 minutes 2.535 seconds)

<a id="sphx-glr-download-auto-examples-self-supervised-learning-demo-multioperator-imaging-py"></a>

[`Download Jupyter notebook: demo_multioperator_imaging.ipynb`](https://deepinv.org/auto_examples/self-supervised-learning/_downloads/8c415d2c1c1749a7f5be2026c4d75e8b/demo_multioperator_imaging.ipynb)

[`Download Python source code: demo_multioperator_imaging.py`](https://deepinv.org/auto_examples/self-supervised-learning/_downloads/0ed8af0d0fd95c7e0dbbaecec30f661a/demo_multioperator_imaging.py)

[`Download zipped: demo_multioperator_imaging.zip`](https://deepinv.org/auto_examples/self-supervised-learning/_downloads/7622905c2e83f37ca13721ec914e10c0/demo_multioperator_imaging.zip)
